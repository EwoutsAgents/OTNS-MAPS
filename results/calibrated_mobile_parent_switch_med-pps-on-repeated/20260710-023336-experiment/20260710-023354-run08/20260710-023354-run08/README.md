# Result: calibrated_mobile_parent_switch / 20260710-023354-run01
...
- Packet delivery ratio: `0.6875`
- Total outage (s): `280.0`
...
```bash
otns-replay calibrated_mobile_parent_switch_20260710T023354Z.replay
```
