# Result: calibrated_mobile_parent_switch / 20260710-023336-run01
...
- Switch position x: `735.897`
- Packet delivery ratio: `0.927083`
- Total outage (s): `60.0`
...
```bash
otns-replay calibrated_mobile_parent_switch_20260710T023336Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py calibrated_mobile_parent_switch_20260710T023336Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
