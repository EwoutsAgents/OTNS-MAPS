# Result: calibrated_mobile_parent_switch / 20260710-023342-run01
...
- Packet delivery ratio: `0.364583`
- Total outage (s): `240.0`
...
```bash
otns-replay calibrated_mobile_parent_switch_20260710T023342Z.replay
```
