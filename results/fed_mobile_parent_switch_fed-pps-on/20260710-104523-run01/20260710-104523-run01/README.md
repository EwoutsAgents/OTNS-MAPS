# Result: fed_mobile_parent_switch_fed-pps-on / 20260710-104523-run01
...
- Switch count: `1`
- First switch time (s): `540.0`
- Switch position x: `141.026`
- Packet delivery ratio: `0.427083`
- Total outage (s): `140.0`
...
```bash
otns-replay fed_mobile_parent_switch_20260710T104523Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py fed_mobile_parent_switch_20260710T104523Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
