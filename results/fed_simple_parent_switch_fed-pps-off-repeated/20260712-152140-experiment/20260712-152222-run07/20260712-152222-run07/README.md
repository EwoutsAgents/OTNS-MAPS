# Result: fed_simple_parent_switch / 20260712-152222-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10360`
...
- Second switch time (s): `788.0`
- Switch position x: `900.0`
- Second switch position x: `900.0`
- Packet delivery ratio: `0.984663`
- Total outage (s): `15.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_c', 'router_b', 'router_c', 'router_b']`
- Time spent by parent (s): `{'router_a': 23.0, 'router_b': 289.0, 'router_c': 23.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T152222Z.replay
```
