# Result: fed_simple_parent_switch / 20260712-152243-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10390`
...
```bash
otns-replay fed_simple_parent_switch_20260712T152243Z.replay
```
