# Result: fed_simple_parent_switch / 20260712-210653-run01
...
- Packet delivery ratio: `0.981424`
- Total outage (s): `29.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 28.0, 'router_c': 314.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T210653Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py fed_simple_parent_switch_20260712T210653Z.replay --frame-count 24 --replay-speed 16 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
