# Result: fed_simple_parent_switch / 20260712-210709-run01
...
- Packet delivery ratio: `0.981707`
- Total outage (s): `24.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 34.0, 'router_c': 310.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T210709Z.replay
```
