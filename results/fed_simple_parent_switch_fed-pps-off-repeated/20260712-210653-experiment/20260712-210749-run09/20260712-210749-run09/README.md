# Result: fed_simple_parent_switch / 20260712-210749-run01
...
- Packet delivery ratio: `0.987952`
- Total outage (s): `18.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 24.0, 'router_c': 320.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T210749Z.replay
```
