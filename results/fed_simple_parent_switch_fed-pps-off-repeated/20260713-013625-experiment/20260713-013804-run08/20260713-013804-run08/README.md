# Result: fed_simple_parent_switch / 20260713-013804-run01
...
- Time spent by parent (s): `{'router_a': 26.0, 'router_c': 599.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T013804Z.replay
```
