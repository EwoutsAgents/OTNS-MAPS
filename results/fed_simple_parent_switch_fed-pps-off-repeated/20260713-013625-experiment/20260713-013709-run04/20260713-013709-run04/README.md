# Result: fed_simple_parent_switch / 20260713-013709-run01
...
- Packet delivery ratio: `0.991763`
- Total outage (s): `24.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c', 'router_b']`
- Time spent by parent (s): `{'router_a': 30.0, 'router_c': 93.0, 'router_b': 498.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T013709Z.replay
```
