# Result: fed_simple_parent_switch / 20260713-013723-run01
...
- Packet delivery ratio: `0.998397`
- Total outage (s): `3.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b']`
- Time spent by parent (s): `{'router_a': 8.0, 'router_b': 618.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T013723Z.replay
```
