# Result: fed_simple_parent_switch / 20260713-013827-run01
...
- Time spent by parent (s): `{'router_a': 33.0, 'router_c': 593.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T013827Z.replay
```
