# Result: fed_simple_parent_switch / 20260713-013652-run01
...
- Initial observed parent: `router_c`
- Pre-movement final parent: `router_c`
- Pre-movement switch count: `1`
- Pre-movement parent events: `[{'phase': 'post_activation_settle', 'sim_time_s': 611.0, 'elapsed_s': 11, 'from_parent': 'router_a', 'to_parent': 'router_c'}]`
- Final observed parent: `router_b`
- Switch count: `1`
- First switch time (s): `1308.0`
- Second switch time (s): `None`
- Switch position x: `1600.0`
- Second switch position x: `None`
- Detach count: `1`
- First detach time (s): `1305.0`
- First detach position x: `1600.0`
- First reattach time (s): `1308.0`
...
- Parent sequence: `['router_c', 'router_b']`
- Time spent by parent (s): `{'router_c': 104.0, 'router_b': 519.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T013652Z.replay
```
