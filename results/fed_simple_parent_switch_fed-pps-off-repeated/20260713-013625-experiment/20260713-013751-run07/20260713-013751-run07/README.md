# Result: fed_simple_parent_switch / 20260713-013751-run01
...
- Time spent by parent (s): `{'router_a': 32.0, 'router_c': 591.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T013751Z.replay
```
