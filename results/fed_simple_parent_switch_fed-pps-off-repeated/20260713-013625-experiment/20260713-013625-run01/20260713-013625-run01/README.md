# Result: fed_simple_parent_switch / 20260713-013625-run01
...
- Packet delivery ratio: `0.991749`
- Total outage (s): `25.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 33.0, 'router_c': 590.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T013625Z.replay
```
