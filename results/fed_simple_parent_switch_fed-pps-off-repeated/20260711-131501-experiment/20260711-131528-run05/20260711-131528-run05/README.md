# Result: fed_simple_parent_switch / 20260711-131528-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10240`
...
- Packet delivery ratio: `0.980892`
- Total outage (s): `25.0`
...
```bash
otns-replay fed_simple_parent_switch_20260711T131528Z.replay
```
