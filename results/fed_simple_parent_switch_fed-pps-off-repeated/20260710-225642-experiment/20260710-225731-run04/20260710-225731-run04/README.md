# Result: fed_simple_parent_switch / 20260710-225731-run01
...
- Switch count: `1`
- First switch time (s): `718.0`
- Switch position x: `750.0`
- Packet delivery ratio: `0.996942`
- Total outage (s): `7.0`
...
```bash
otns-replay fed_simple_parent_switch_20260710T225731Z.replay
```
