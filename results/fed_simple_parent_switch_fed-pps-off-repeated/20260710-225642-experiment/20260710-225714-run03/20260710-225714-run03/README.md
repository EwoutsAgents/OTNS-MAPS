# Result: fed_simple_parent_switch / 20260710-225714-run01
...
- Switch count: `1`
- First switch time (s): `589.0`
- Switch position x: `750.0`
- Packet delivery ratio: `0.99375`
- Total outage (s): `15.0`
...
```bash
otns-replay fed_simple_parent_switch_20260710T225714Z.replay
```
