# Result: fed_simple_parent_switch / 20260713-010055-run01
...
- Pre-movement parent events: `[{'phase': 'post_activation_settle', 'sim_time_s': 310.0, 'elapsed_s': 10, 'from_parent': 'router_a', 'to_parent': 'router_b'}]`
...
- Time spent by parent (s): `{'router_b': 34.0, 'router_c': 311.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T010055Z.replay
```
