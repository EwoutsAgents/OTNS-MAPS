# Result: fed_simple_parent_switch / 20260713-010019-run01
...
- Pre-movement parent events: `[{'phase': 'post_activation_settle', 'sim_time_s': 311.0, 'elapsed_s': 11, 'from_parent': 'router_a', 'to_parent': 'router_b'}]`
...
- Detach count: `1`
- First detach time (s): `511.0`
- First detach position x: `1600.0`
- First reattach time (s): `512.0`
...
- Time spent by parent (s): `{'router_b': 30.0, 'router_c': 315.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T010019Z.replay
```
