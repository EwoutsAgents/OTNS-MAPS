# Result: fed_simple_parent_switch / 20260713-010047-run01
...
- Packet delivery ratio: `0.940594`
- Total outage (s): `61.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b']`
- Time spent by parent (s): `{'router_a': 89.0, 'router_b': 254.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T010047Z.replay
```
