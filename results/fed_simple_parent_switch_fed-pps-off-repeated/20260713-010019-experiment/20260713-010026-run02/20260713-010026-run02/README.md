# Result: fed_simple_parent_switch / 20260713-010026-run01
...
- Time spent by parent (s): `{'router_a': 31.0, 'router_b': 314.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T010026Z.replay
```
