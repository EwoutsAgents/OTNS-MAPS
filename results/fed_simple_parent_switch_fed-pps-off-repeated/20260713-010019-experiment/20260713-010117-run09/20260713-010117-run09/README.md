# Result: fed_simple_parent_switch / 20260713-010117-run01
...
- Time spent by parent (s): `{'router_a': 25.0, 'router_b': 318.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T010117Z.replay
```
