# Result: fed_simple_parent_switch / 20260710-174527-run01
...
- Switch position x: `485.897`
- Packet delivery ratio: `0.958333`
- Total outage (s): `40.0`
...
```bash
otns-replay fed_simple_parent_switch_20260710T174527Z.replay
```
