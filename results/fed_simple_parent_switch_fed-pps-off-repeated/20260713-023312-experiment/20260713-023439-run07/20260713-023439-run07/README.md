# Result: fed_simple_parent_switch / 20260713-023439-run01
...
- Time spent by parent (s): `{'router_a': 41.0, 'router_d': 596.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023439Z.replay
```
