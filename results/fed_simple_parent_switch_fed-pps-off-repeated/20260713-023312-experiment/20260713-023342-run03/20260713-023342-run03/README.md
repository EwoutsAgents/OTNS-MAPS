# Result: fed_simple_parent_switch / 20260713-023342-run01
...
- Time spent by parent (s): `{'router_a': 30.0, 'router_d': 607.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023342Z.replay
```
