# Result: fed_simple_parent_switch / 20260713-023507-run01
...
- Second switch time (s): `1235.0`
- Switch position x: `1779.861`
- Second switch position x: `2026.389`
- Detach count: `1`
- First detach time (s): `1229.0`
- First detach position x: `1730.556`
- First reattach time (s): `1230.0`
- First reattach position x: `1779.861`
- Reattach latency (s): `1.0`
- Ended detached: `False`
- Recovery classification: `detached_reattached_new_parent`
- Packet delivery ratio: `0.991948`
- Total outage (s): `21.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c', 'router_d']`
- Time spent by parent (s): `{'router_a': 28.0, 'router_c': 5.0, 'router_d': 603.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023507Z.replay
```
