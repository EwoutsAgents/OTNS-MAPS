# Result: fed_simple_parent_switch / 20260713-023312-run01
...
- Switch count: `1`
- First switch time (s): `1218.0`
- Second switch time (s): `None`
- Switch position x: `1188.194`
...
- Packet delivery ratio: `0.99681`
- Total outage (s): `12.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_d']`
- Time spent by parent (s): `{'router_a': 17.0, 'router_d': 620.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023312Z.replay
```
