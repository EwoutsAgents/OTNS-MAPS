# Result: fed_simple_parent_switch / 20260713-023453-run01
...
- Time spent by parent (s): `{'router_a': 27.0, 'router_c': 17.0, 'router_d': 591.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023453Z.replay
```
