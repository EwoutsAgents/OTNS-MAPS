# Result: fed_simple_parent_switch / 20260713-023522-run01
...
- Switch count: `3`
- First switch time (s): `1207.0`
- Second switch time (s): `1218.0`
- Switch position x: `645.833`
- Second switch position x: `1188.194`
- Detach count: `1`
- First detach time (s): `1238.0`
- First detach position x: `2125.0`
- First reattach time (s): `1239.0`
...
- Packet delivery ratio: `0.988655`
- Total outage (s): `27.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c', 'router_b', 'router_d']`
- Time spent by parent (s): `{'router_a': 6.0, 'router_c': 11.0, 'router_b': 20.0, 'router_d': 599.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023522Z.replay
```
