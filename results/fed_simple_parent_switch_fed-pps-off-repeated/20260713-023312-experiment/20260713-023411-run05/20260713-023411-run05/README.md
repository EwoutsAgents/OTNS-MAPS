# Result: fed_simple_parent_switch / 20260713-023411-run01
...
- Pre-movement parent events: `[{'phase': 'post_activation_settle', 'sim_time_s': 1182.0, 'elapsed_s': 582, 'from_parent': 'router_a', 'to_parent': 'router_c'}]`
...
- Packet delivery ratio: `0.996825`
- Total outage (s): `9.0`
- Oscillation events: `0`
- Parent sequence: `['router_c']`
- Time spent by parent (s): `{'router_c': 637.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023411Z.replay
```
