# Result: fed_simple_parent_switch / 20260713-023424-run01
...
- Packet delivery ratio: `0.991987`
- Total outage (s): `18.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_d']`
- Time spent by parent (s): `{'router_a': 31.0, 'router_d': 606.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023424Z.replay
```
