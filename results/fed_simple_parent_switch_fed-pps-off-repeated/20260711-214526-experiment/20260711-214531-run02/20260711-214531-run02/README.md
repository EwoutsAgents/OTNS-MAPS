# Result: fed_simple_parent_switch / 20260711-214531-run01
...
- Packet delivery ratio: `0.777778`
- Total outage (s): `321.0`
...
```bash
otns-replay fed_simple_parent_switch_20260711T214531Z.replay
```
