# Result: fed_simple_parent_switch / 20260712-192018-run01
...
- Time spent by parent (s): `{'router_b': 289.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192018Z.replay
```
