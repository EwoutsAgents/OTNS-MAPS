# Result: fed_simple_parent_switch / 20260712-192024-run01
...
- Time spent by parent (s): `{'router_a': 42.0, 'router_c': 308.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192024Z.replay
```
