# Result: fed_simple_parent_switch / 20260712-192012-run01
...
- Time spent by parent (s): `{'router_c': 294.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192012Z.replay
```
