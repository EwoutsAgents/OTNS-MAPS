# Result: fed_simple_parent_switch / 20260712-192005-run01
...
- Time spent by parent (s): `{'router_a': 28.0, 'router_c': 320.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192005Z.replay
```
