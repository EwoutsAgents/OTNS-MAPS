# Result: fed_simple_parent_switch / 20260712-192045-run01
...
- Time spent by parent (s): `{'router_a': 71.0, 'router_c': 277.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192045Z.replay
```
