# Result: fed_simple_parent_switch / 20260712-165658-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11320`
...
```bash
otns-replay fed_simple_parent_switch_20260712T165658Z.replay
```
