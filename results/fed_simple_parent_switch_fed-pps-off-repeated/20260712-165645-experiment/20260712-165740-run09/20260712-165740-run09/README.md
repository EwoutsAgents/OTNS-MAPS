# Result: fed_simple_parent_switch / 20260712-165740-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11380`
...
- Time spent by parent (s): `{'router_b': 16.0, 'router_c': 329.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T165740Z.replay
```
