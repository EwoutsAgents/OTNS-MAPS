# Result: fed_simple_parent_switch / 20260712-165712-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11340`
...
- Packet delivery ratio: `0.993902`
- Total outage (s): `19.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 31.0, 'router_c': 311.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T165712Z.replay
```
