# Result: fed_simple_parent_switch / 20260712-165651-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11310`
...
```bash
otns-replay fed_simple_parent_switch_20260712T165651Z.replay
```
