# Result: fed_simple_parent_switch / 20260712-231952-run01
...
- Time spent by parent (s): `{'router_a': 22.0, 'router_c': 324.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T231952Z.replay
```
