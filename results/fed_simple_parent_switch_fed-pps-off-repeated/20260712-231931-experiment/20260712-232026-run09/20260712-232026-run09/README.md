# Result: fed_simple_parent_switch / 20260712-232026-run01
...
- Detach count: `1`
- First detach time (s): `221.0`
- First detach position x: `1600.0`
- First reattach time (s): `224.0`
...
```bash
otns-replay fed_simple_parent_switch_20260712T232026Z.replay
```
