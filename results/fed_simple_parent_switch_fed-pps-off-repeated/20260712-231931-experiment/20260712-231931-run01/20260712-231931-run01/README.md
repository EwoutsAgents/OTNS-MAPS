# Result: fed_simple_parent_switch / 20260712-231931-run01
...
- Detach count: `1`
- First detach time (s): `214.0`
- First detach position x: `1500.0`
- First reattach time (s): `217.0`
...
- Time spent by parent (s): `{'router_a': 23.0, 'router_b': 320.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T231931Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py fed_simple_parent_switch_20260712T231931Z.replay --frame-count 24 --replay-speed 16 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
