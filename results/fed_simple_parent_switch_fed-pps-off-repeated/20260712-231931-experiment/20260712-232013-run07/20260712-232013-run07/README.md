# Result: fed_simple_parent_switch / 20260712-232013-run01
...
- Switch count: `1`
- First switch time (s): `208.0`
- Second switch time (s): `None`
- Switch position x: `1200.0`
...
- Packet delivery ratio: `0.997067`
- Total outage (s): `6.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 17.0, 'router_c': 329.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T232013Z.replay
```
