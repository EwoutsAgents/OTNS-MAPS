# Result: calibrated_mobile_parent_switch / 20260710-023307-run01
...
- Packet delivery ratio: `0.489583`
- Total outage (s): `20.0`
...
```bash
otns-replay calibrated_mobile_parent_switch_20260710T023307Z.replay
```
