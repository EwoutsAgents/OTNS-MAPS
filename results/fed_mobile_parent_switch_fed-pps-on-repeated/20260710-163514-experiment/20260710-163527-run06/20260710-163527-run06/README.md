# Result: fed_mobile_parent_switch / 20260710-163527-run01
...
- Switch count: `1`
- First switch time (s): `640.0`
- Switch position x: `243.59`
...
```bash
otns-replay fed_mobile_parent_switch_20260710T163527Z.replay
```
