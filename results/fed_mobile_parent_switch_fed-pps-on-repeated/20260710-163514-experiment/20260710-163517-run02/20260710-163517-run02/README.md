# Result: fed_mobile_parent_switch / 20260710-163517-run01
...
- Packet delivery ratio: `0.395833`
- Total outage (s): `200.0`
...
```bash
otns-replay fed_mobile_parent_switch_20260710T163517Z.replay
```
