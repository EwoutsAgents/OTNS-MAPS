# Result: sed_simple_parent_switch / 20260712-232151-run01
...
- Packet delivery ratio: `0.982036`
- Total outage (s): `1.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 28.0, 'router_c': 317.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T232151Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py sed_simple_parent_switch_20260712T232151Z.replay --frame-count 24 --replay-speed 16 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
