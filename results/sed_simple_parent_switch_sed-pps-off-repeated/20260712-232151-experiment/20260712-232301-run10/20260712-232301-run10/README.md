# Result: sed_simple_parent_switch / 20260712-232301-run01
...
- Time spent by parent (s): `{'router_a': 26.0, 'router_c': 319.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T232301Z.replay
```
