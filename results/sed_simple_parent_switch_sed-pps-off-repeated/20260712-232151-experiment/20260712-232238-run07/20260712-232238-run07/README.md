# Result: sed_simple_parent_switch / 20260712-232238-run01
...
- Detach count: `1`
- First detach time (s): `224.0`
- First detach position x: `1600.0`
- First reattach time (s): `225.0`
...
- Packet delivery ratio: `0.978916`
- Total outage (s): `1.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 33.0, 'router_c': 312.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T232238Z.replay
```
