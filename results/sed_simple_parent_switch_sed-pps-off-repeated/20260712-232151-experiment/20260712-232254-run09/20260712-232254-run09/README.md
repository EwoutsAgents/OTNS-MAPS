# Result: sed_simple_parent_switch / 20260712-232254-run01
...
- Time spent by parent (s): `{'router_a': 25.0, 'router_c': 318.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T232254Z.replay
```
