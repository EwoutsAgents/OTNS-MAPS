# Result: sed_simple_parent_switch / 20260710-211542-run01
...
- Packet delivery ratio: `0.989796`
- Total outage (s): `1.0`
...
```bash
otns-replay sed_simple_parent_switch_20260710T211542Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py sed_simple_parent_switch_20260710T211542Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
