# Result: sed_simple_parent_switch / 20260712-152512-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10590`
...
- Time spent by parent (s): `{'router_a': 23.0, 'router_b': 310.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T152512Z.replay
```
