# Result: sed_simple_parent_switch / 20260713-023858-run01
...
- Switch position x: `2075.694`
- Second switch position x: `None`
- Detach count: `1`
- First detach time (s): `1235.0`
- First detach position x: `2026.389`
- First reattach time (s): `1236.0`
- First reattach position x: `2075.694`
...
- Time spent by parent (s): `{'router_a': 34.0, 'router_d': 602.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T023858Z.replay
```
