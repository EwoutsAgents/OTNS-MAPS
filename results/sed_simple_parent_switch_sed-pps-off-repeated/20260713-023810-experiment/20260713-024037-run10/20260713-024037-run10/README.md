# Result: sed_simple_parent_switch / 20260713-024037-run01
...
- Second switch time (s): `1247.0`
- Switch position x: `1484.028`
- Second switch position x: `2125.0`
- Detach count: `2`
- First detach time (s): `1220.0`
- First detach position x: `1286.806`
- First reattach time (s): `1224.0`
- First reattach position x: `1484.028`
- Reattach latency (s): `4.0`
- Ended detached: `False`
- Recovery classification: `detached_reattached_new_parent`
- Packet delivery ratio: `0.986949`
- Total outage (s): `5.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_d']`
- Time spent by parent (s): `{'router_a': 19.0, 'router_b': 22.0, 'router_d': 591.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T024037Z.replay
```
