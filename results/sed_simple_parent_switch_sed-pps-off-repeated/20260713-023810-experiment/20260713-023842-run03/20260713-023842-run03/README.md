# Result: sed_simple_parent_switch / 20260713-023842-run01
...
- Second switch time (s): `1248.0`
- Switch position x: `1484.028`
- Second switch position x: `2125.0`
- Detach count: `2`
- First detach time (s): `1223.0`
- First detach position x: `1434.722`
...
- Packet delivery ratio: `0.988691`
- Total outage (s): `4.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c', 'router_d']`
- Time spent by parent (s): `{'router_a': 22.0, 'router_c': 21.0, 'router_d': 590.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T023842Z.replay
```
