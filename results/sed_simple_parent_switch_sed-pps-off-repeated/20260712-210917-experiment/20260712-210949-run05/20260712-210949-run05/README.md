# Result: sed_simple_parent_switch / 20260712-210949-run01
...
- Time spent by parent (s): `{'router_a': 30.0, 'router_c': 313.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T210949Z.replay
```
