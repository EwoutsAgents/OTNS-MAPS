# Result: sed_simple_parent_switch / 20260712-211019-run01
...
- Packet delivery ratio: `0.978659`
- Total outage (s): `3.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b']`
- Time spent by parent (s): `{'router_a': 33.0, 'router_b': 310.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T211019Z.replay
```
