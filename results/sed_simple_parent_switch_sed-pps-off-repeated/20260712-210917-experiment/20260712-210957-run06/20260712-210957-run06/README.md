# Result: sed_simple_parent_switch / 20260712-210957-run01
...
- Time spent by parent (s): `{'router_a': 29.0, 'router_c': 314.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T210957Z.replay
```
