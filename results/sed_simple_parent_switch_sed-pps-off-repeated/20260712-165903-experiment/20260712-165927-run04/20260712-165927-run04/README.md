# Result: sed_simple_parent_switch / 20260712-165927-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11530`
...
```bash
otns-replay sed_simple_parent_switch_20260712T165927Z.replay
```
