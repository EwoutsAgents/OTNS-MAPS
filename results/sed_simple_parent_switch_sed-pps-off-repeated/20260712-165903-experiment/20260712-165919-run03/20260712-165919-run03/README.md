# Result: sed_simple_parent_switch / 20260712-165919-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11520`
...
- Time spent by parent (s): `{'router_a': 31.0, 'router_b': 311.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T165919Z.replay
```
