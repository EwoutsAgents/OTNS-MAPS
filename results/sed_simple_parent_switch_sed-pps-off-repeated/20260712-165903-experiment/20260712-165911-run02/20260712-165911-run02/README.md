# Result: sed_simple_parent_switch / 20260712-165911-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11510`
...
- Packet delivery ratio: `0.994135`
- Total outage (s): `0.0`
...
```bash
otns-replay sed_simple_parent_switch_20260712T165911Z.replay
```
