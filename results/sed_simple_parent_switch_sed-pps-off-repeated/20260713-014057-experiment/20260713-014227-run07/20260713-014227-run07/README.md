# Result: sed_simple_parent_switch / 20260713-014227-run01
...
- Packet delivery ratio: `0.988562`
- Total outage (s): `1.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 33.0, 'router_c': 592.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T014227Z.replay
```
