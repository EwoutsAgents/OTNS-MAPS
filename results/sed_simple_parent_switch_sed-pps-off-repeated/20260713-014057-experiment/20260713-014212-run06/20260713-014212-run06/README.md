# Result: sed_simple_parent_switch / 20260713-014212-run01
...
- Time spent by parent (s): `{'router_a': 28.0, 'router_c': 597.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T014212Z.replay
```
