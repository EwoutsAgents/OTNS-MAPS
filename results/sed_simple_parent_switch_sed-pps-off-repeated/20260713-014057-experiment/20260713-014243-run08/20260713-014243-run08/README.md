# Result: sed_simple_parent_switch / 20260713-014243-run01
...
- Time spent by parent (s): `{'router_a': 31.0, 'router_c': 594.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T014243Z.replay
```
