# Result: sed_simple_parent_switch / 20260713-014158-run01
...
- Time spent by parent (s): `{'router_a': 30.0, 'router_c': 595.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T014158Z.replay
```
