# Result: sed_simple_parent_switch / 20260713-014128-run01
...
- Time spent by parent (s): `{'router_a': 29.0, 'router_c': 596.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T014128Z.replay
```
