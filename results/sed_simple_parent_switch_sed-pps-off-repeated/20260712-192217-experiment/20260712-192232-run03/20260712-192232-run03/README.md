# Result: sed_simple_parent_switch / 20260712-192232-run01
...
- Time spent by parent (s): `{'router_a': 38.0, 'router_b': 298.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T192232Z.replay
```
