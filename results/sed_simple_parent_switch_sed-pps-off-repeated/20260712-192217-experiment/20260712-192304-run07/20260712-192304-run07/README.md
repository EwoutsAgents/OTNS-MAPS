# Result: sed_simple_parent_switch / 20260712-192304-run01
...
- Packet delivery ratio: `0.985163`
- Total outage (s): `3.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b']`
- Time spent by parent (s): `{'router_a': 37.0, 'router_b': 311.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T192304Z.replay
```
