# Result: sed_simple_parent_switch / 20260712-192312-run01
...
- Time spent by parent (s): `{'router_a': 37.0, 'router_b': 134.0, 'router_c': 174.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T192312Z.replay
```
