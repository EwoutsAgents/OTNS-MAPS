# Result: sed_simple_parent_switch / 20260712-192224-run01
...
- Time spent by parent (s): `{'router_a': 31.0, 'router_c': 317.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T192224Z.replay
```
