# Result: sed_simple_parent_switch / 20260713-010247-run01
...
- Detach count: `1`
- First detach time (s): `504.0`
- First detach position x: `1500.0`
...
- Packet delivery ratio: `0.988166`
- Total outage (s): `1.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 23.0, 'router_c': 322.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010247Z.replay
```
