# Result: sed_simple_parent_switch / 20260713-010313-run01
...
- Detach count: `1`
- First detach time (s): `514.0`
- First detach position x: `1600.0`
- First reattach time (s): `515.0`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010313Z.replay
```
