# Result: sed_simple_parent_switch / 20260713-010356-run01
...
- Time spent by parent (s): `{'router_a': 346.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010356Z.replay
```
