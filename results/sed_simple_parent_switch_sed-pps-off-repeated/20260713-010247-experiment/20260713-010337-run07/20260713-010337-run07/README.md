# Result: sed_simple_parent_switch / 20260713-010337-run01

Simple stock OTNS parent-switching benchmark for a mobile Sleepy End Device. The scenario uses three routers, one mobile end device, straight-line movement, delayed Router B/Router C activation, static 0 dBm transmit power, and no intentional dead zone. The mobile is created near Router A and given a fixed Router-A-only attachment window, then moves beyond Router C at a target 5 m/s and dwells at the end to expose late parent switching. Parent-command output is the primary attachment observation path because ping-based packet probing is not reliable for regular SEDs.
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10050`
...
- Switch count: `1`
- First switch time (s): `505.0`
- Second switch time (s): `None`
- Switch position x: `1550.0`
- Second switch position x: `None`
- Detach count: `1`
- First detach time (s): `502.0`
- First detach position x: `1400.0`
- First reattach time (s): `505.0`
- First reattach position x: `1550.0`
- Reattach latency (s): `3.0`
- Ended detached: `False`
- Recovery classification: `detached_reattached_new_parent`
- Packet delivery ratio: `0.991071`
- Total outage (s): `3.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 21.0, 'router_c': 322.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010337Z.replay
```
