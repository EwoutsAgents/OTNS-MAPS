# Result: sed_simple_parent_switch / 20260713-010404-run01
...
- Time spent by parent (s): `{'router_a': 34.0, 'router_c': 311.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010404Z.replay
```
