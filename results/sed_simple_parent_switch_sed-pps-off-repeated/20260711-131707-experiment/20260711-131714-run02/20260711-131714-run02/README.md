# Result: sed_simple_parent_switch / 20260711-131714-run01
...
- Switch count: `1`
- First switch time (s): `605.0`
- Switch position x: `750.0`
- Packet delivery ratio: `0.96463`
- Total outage (s): `1.0`
...
```bash
otns-replay sed_simple_parent_switch_20260711T131714Z.replay
```
