# Result: fed_simple_parent_switch / 20260712-165842-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11470`
...
- Packet delivery ratio: `0.990964`
- Total outage (s): `16.0`
...
```bash
otns-replay fed_simple_parent_switch_20260712T165842Z.replay
```
