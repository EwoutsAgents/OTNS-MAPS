# Result: fed_simple_parent_switch / 20260712-165828-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11450`
...
- Packet delivery ratio: `0.994083`
- Total outage (s): `9.0`
...
```bash
otns-replay fed_simple_parent_switch_20260712T165828Z.replay
```
