# Result: fed_simple_parent_switch / 20260712-165807-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11420`
...
- Second switch time (s): `514.0`
- Switch position x: `650.0`
- Second switch position x: `1350.0`
- Packet delivery ratio: `0.991045`
- Total outage (s): `13.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_c']`
- Time spent by parent (s): `{'router_a': 10.0, 'router_b': 20.0, 'router_c': 312.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T165807Z.replay
```
