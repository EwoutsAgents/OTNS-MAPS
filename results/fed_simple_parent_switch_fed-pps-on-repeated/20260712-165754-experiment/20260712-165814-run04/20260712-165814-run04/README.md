# Result: fed_simple_parent_switch / 20260712-165814-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11430`
...
- Time spent by parent (s): `{'router_a': 29.0, 'router_c': 313.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T165814Z.replay
```
