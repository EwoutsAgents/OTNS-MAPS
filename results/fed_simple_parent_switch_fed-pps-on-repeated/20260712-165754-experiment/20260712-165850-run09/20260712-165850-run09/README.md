# Result: fed_simple_parent_switch / 20260712-165850-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11480`
...
- Time spent by parent (s): `{'router_a': 46.0, 'router_c': 299.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T165850Z.replay
```
