# Result: fed_simple_parent_switch / 20260712-165857-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11490`
...
- Switch count: `1`
- First switch time (s): `490.0`
- Second switch time (s): `None`
- Switch position x: `600.0`
- Second switch position x: `None`
- Packet delivery ratio: `0.997085`
- Total outage (s): `3.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 9.0, 'router_c': 336.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T165857Z.replay
```
