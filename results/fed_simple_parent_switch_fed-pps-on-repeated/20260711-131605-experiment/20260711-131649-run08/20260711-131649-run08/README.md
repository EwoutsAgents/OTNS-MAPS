# Result: fed_simple_parent_switch / 20260711-131649-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10370`
...
```bash
otns-replay fed_simple_parent_switch_20260711T131649Z.replay
```
