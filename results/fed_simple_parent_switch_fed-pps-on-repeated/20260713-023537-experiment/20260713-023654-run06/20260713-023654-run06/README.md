# Result: fed_simple_parent_switch / 20260713-023654-run01
...
- Parent sequence: `['router_b', 'router_d']`
- Time spent by parent (s): `{'router_b': 43.0, 'router_d': 593.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023654Z.replay
```
