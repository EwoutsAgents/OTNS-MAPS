# Result: fed_simple_parent_switch / 20260713-023552-run01
...
- Second switch time (s): `1215.0`
- Switch position x: `843.056`
- Second switch position x: `1040.278`
- Detach count: `0`
...
- Packet delivery ratio: `0.998403`
- Total outage (s): `12.0`
- Oscillation events: `2`
- Parent sequence: `['router_a', 'router_b', 'router_c', 'router_b', 'router_c', 'router_d']`
- Time spent by parent (s): `{'router_a': 10.0, 'router_b': 11.0, 'router_c': 46.0, 'router_d': 570.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023552Z.replay
```
