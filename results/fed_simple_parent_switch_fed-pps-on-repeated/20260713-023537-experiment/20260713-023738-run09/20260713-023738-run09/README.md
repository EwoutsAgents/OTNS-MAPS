# Result: fed_simple_parent_switch / 20260713-023738-run01
...
- Pre-movement final parent: `router_b`
- Pre-movement switch count: `1`
- Pre-movement parent events: `[{'phase': 'post_activation_settle', 'sim_time_s': 611.0, 'elapsed_s': 11, 'from_parent': 'router_a', 'to_parent': 'router_b'}]`
- Final observed parent: `router_c`
- Switch count: `1`
- First switch time (s): `1248.0`
- Second switch time (s): `None`
- Switch position x: `2125.0`
- Second switch position x: `None`
- Detach count: `1`
- First detach time (s): `1245.0`
- First detach position x: `2125.0`
- First reattach time (s): `1248.0`
...
- Packet delivery ratio: `0.991896`
- Total outage (s): `25.0`
- Oscillation events: `0`
- Parent sequence: `['router_b', 'router_c']`
- Time spent by parent (s): `{'router_b': 44.0, 'router_c': 590.0}`
...
- Result classification: `pre_movement_switch_observed`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023738Z.replay
```
