# Result: fed_simple_parent_switch / 20260713-023620-run01
...
- Switch count: `21`
- First switch time (s): `1224.0`
- Second switch time (s): `1614.0`
- Switch position x: `1484.028`
...
- Packet delivery ratio: `0.993579`
- Total outage (s): `18.0`
- Oscillation events: `19`
- Parent sequence: `['router_a', 'router_d', 'router_c', 'router_d', 'router_c', 'router_d', 'router_c', 'router_d', 'router_c', 'router_d', 'router_c', 'router_d', 'router_c', 'router_d', 'router_c', 'router_d', 'router_c', 'router_d', 'router_c', 'router_d', 'router_c', 'router_d']`
- Time spent by parent (s): `{'router_a': 23.0, 'router_d': 572.0, 'router_c': 42.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023620Z.replay
```
