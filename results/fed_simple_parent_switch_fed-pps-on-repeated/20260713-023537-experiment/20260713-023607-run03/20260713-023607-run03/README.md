# Result: fed_simple_parent_switch / 20260713-023607-run01
...
- Packet delivery ratio: `0.988764`
- Total outage (s): `21.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c', 'router_d']`
- Time spent by parent (s): `{'router_a': 26.0, 'router_c': 417.0, 'router_d': 193.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023607Z.replay
```
