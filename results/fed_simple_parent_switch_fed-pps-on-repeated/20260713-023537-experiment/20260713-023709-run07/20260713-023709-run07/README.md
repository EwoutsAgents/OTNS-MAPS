# Result: fed_simple_parent_switch / 20260713-023709-run01
...
- First detach position x: `1681.25`
...
- Packet delivery ratio: `0.988599`
- Total outage (s): `30.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c', 'router_d']`
- Time spent by parent (s): `{'router_a': 27.0, 'router_c': 14.0, 'router_d': 593.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T023709Z.replay
```
