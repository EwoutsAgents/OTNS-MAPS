# Result: fed_simple_parent_switch / 20260712-192107-run01
...
- Time spent by parent (s): `{'router_a': 39.0, 'router_c': 309.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192107Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py fed_simple_parent_switch_20260712T192107Z.replay --frame-count 24 --replay-speed 16 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
