# Result: fed_simple_parent_switch / 20260712-192142-run01
...
- Second switch time (s): `825.0`
- Switch position x: `1500.0`
- Second switch position x: `1500.0`
- Packet delivery ratio: `0.974453`
- Total outage (s): `84.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_c']`
- Time spent by parent (s): `{'router_a': 36.0, 'router_b': 253.0, 'router_c': 7.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192142Z.replay
```
