# Result: fed_simple_parent_switch / 20260712-192121-run01
...
- Time spent by parent (s): `{'router_a': 35.0, 'router_c': 316.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192121Z.replay
```
