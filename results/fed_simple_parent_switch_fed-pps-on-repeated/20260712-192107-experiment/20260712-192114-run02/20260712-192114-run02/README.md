# Result: fed_simple_parent_switch / 20260712-192114-run01
...
- Time spent by parent (s): `{'router_a': 36.0, 'router_c': 314.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192114Z.replay
```
