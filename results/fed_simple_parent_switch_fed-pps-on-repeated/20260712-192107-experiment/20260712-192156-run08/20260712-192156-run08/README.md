# Result: fed_simple_parent_switch / 20260712-192156-run01
...
- Packet delivery ratio: `0.981191`
- Total outage (s): `38.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 38.0, 'router_c': 291.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192156Z.replay
```
