# Result: fed_simple_parent_switch / 20260712-192210-run01
...
- Time spent by parent (s): `{'router_a': 30.0, 'router_c': 318.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192210Z.replay
```
