# Result: fed_simple_parent_switch / 20260712-192149-run01
...
- Time spent by parent (s): `{'router_a': 39.0, 'router_c': 311.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192149Z.replay
```
