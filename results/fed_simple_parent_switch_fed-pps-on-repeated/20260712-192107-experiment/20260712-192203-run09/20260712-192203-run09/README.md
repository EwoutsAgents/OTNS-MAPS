# Result: fed_simple_parent_switch / 20260712-192203-run01
...
- Packet delivery ratio: `0.994186`
- Total outage (s): `9.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 86.0, 'router_c': 265.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192203Z.replay
```
