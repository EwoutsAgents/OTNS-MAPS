# Result: fed_simple_parent_switch / 20260712-192135-run01
...
- Second switch time (s): `734.0`
- Switch position x: `1500.0`
- Second switch position x: `1500.0`
- Packet delivery ratio: `0.978528`
- Total outage (s): `32.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_c']`
- Time spent by parent (s): `{'router_a': 37.0, 'router_b': 210.0, 'router_c': 98.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T192135Z.replay
```
