# Result: fed_simple_parent_switch / 20260712-232048-run01
...
- Time spent by parent (s): `{'router_a': 26.0, 'router_c': 320.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T232048Z.replay
```
