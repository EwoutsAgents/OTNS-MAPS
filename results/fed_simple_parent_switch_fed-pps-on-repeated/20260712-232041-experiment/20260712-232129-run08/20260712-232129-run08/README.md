# Result: fed_simple_parent_switch / 20260712-232129-run01
...
- Time spent by parent (s): `{'router_a': 310.0, 'router_c': 36.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T232129Z.replay
```
