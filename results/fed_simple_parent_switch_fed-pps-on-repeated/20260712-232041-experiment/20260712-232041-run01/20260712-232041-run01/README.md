# Result: fed_simple_parent_switch / 20260712-232041-run01
...
- Switch count: `1`
- First switch time (s): `212.0`
- Second switch time (s): `None`
- Switch position x: `1400.0`
- Second switch position x: `None`
- Detach count: `1`
- First detach time (s): `211.0`
- First detach position x: `1350.0`
- First reattach time (s): `212.0`
- First reattach position x: `1400.0`
...
- Time spent by parent (s): `{'router_a': 20.0, 'router_c': 325.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T232041Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py fed_simple_parent_switch_20260712T232041Z.replay --frame-count 24 --replay-speed 16 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
