# Result: fed_simple_parent_switch / 20260712-232137-run01
...
- Time spent by parent (s): `{'router_a': 8.0, 'router_b': 26.0, 'router_c': 311.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T232137Z.replay
```
