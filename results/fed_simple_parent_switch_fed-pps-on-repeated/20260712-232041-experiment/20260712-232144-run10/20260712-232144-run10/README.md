# Result: fed_simple_parent_switch / 20260712-232144-run01
...
- Time spent by parent (s): `{'router_a': 23.0, 'router_c': 323.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T232144Z.replay
```
