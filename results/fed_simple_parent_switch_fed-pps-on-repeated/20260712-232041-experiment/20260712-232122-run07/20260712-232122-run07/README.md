# Result: fed_simple_parent_switch / 20260712-232122-run01
...
- Pre-movement parent events: `[{'phase': 'post_activation_settle', 'sim_time_s': 21.0, 'elapsed_s': 11, 'from_parent': 'router_a', 'to_parent': 'router_b'}]`
...
- Packet delivery ratio: `0.98806`
- Total outage (s): `15.0`
- Oscillation events: `0`
- Parent sequence: `['router_b', 'router_c']`
- Time spent by parent (s): `{'router_b': 31.0, 'router_c': 314.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T232122Z.replay
```
