# Result: fed_simple_parent_switch / 20260710-211443-run01
...
- Switch count: `1`
- First switch time (s): `539.0`
- Switch position x: `750.0`
- Packet delivery ratio: `0.994898`
- Total outage (s): `23.0`
...
```bash
otns-replay fed_simple_parent_switch_20260710T211443Z.replay
```
