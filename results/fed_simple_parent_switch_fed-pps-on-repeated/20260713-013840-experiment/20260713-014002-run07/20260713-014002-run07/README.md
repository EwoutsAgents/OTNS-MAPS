# Result: fed_simple_parent_switch / 20260713-014002-run01
...
- Packet delivery ratio: `0.996769`
- Total outage (s): `9.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 21.0, 'router_c': 605.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T014002Z.replay
```
