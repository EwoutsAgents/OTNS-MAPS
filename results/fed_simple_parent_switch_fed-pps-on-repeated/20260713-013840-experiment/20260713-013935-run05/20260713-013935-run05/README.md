# Result: fed_simple_parent_switch / 20260713-013935-run01
...
- Pre-movement parent events: `[{'phase': 'post_activation_settle', 'sim_time_s': 662.0, 'elapsed_s': 62, 'from_parent': 'router_a', 'to_parent': 'router_b'}]`
- Final observed parent: `router_c`
- Switch count: `1`
- First switch time (s): `1236.0`
...
- Packet delivery ratio: `0.991843`
- Total outage (s): `18.0`
- Oscillation events: `0`
- Parent sequence: `['router_b', 'router_c']`
- Time spent by parent (s): `{'router_b': 34.0, 'router_c': 591.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T013935Z.replay
```
