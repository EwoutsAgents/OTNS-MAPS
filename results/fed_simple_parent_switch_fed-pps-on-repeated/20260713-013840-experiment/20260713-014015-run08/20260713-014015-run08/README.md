# Result: fed_simple_parent_switch / 20260713-014015-run01
...
- Packet delivery ratio: `0.98843`
- Total outage (s): `28.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 369.0, 'router_c': 254.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T014015Z.replay
```
