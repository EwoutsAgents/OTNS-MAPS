# Result: fed_simple_parent_switch / 20260713-013840-run01
...
- Packet delivery ratio: `0.996737`
- Total outage (s): `15.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 23.0, 'router_c': 603.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T013840Z.replay
```
