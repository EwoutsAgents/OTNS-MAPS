# Result: fed_simple_parent_switch / 20260712-210803-run01
...
- Time spent by parent (s): `{'router_a': 27.0, 'router_b': 316.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T210803Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py fed_simple_parent_switch_20260712T210803Z.replay --frame-count 24 --replay-speed 16 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
