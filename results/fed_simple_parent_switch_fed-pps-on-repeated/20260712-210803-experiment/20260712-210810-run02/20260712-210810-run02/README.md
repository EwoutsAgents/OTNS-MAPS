# Result: fed_simple_parent_switch / 20260712-210810-run01
...
- Packet delivery ratio: `0.877395`
- Total outage (s): `116.0`
- Oscillation events: `0`
- Parent sequence: `['router_b']`
- Time spent by parent (s): `{'router_b': 343.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T210810Z.replay
```
