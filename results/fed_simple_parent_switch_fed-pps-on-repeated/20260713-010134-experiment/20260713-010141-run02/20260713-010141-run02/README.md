# Result: fed_simple_parent_switch / 20260713-010141-run01
...
- Time spent by parent (s): `{'router_a': 30.0, 'router_b': 316.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T010141Z.replay
```
