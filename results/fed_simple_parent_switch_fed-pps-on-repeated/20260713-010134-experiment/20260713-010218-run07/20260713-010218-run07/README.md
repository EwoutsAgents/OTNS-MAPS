# Result: fed_simple_parent_switch / 20260713-010218-run01
...
- Detach count: `1`
- First detach time (s): `513.0`
- First detach position x: `1600.0`
- First reattach time (s): `514.0`
...
- Time spent by parent (s): `{'router_a': 32.0, 'router_c': 313.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T010218Z.replay
```
