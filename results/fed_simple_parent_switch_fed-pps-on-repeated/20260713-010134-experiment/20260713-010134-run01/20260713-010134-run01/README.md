# Result: fed_simple_parent_switch / 20260713-010134-run01
...
- Time spent by parent (s): `{'router_a': 34.0, 'router_b': 309.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260713T010134Z.replay
```
