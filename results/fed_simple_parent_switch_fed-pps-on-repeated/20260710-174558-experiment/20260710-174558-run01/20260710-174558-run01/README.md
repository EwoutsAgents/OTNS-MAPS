# Result: fed_simple_parent_switch / 20260710-174558-run01

Simple stock OTNS parent-switching benchmark for a mobile Full End Device. The scenario uses two routers, one mobile end device, straight-line movement, delayed Router B activation, overlapping intended coverage, and no intentional dead zone.
...
```bash
otns-replay fed_simple_parent_switch_20260710T174558Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py fed_simple_parent_switch_20260710T174558Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
