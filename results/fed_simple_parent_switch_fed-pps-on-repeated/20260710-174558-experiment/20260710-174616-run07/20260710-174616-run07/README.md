# Result: fed_simple_parent_switch / 20260710-174616-run01
...
- Switch count: `1`
- First switch time (s): `1120.0`
- Switch position x: `567.949`
...
```bash
otns-replay fed_simple_parent_switch_20260710T174616Z.replay
```
