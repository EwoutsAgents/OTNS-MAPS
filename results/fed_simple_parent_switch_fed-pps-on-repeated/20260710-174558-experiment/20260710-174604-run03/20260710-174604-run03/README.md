# Result: fed_simple_parent_switch / 20260710-174604-run01
...
- Switch position x: `557.692`
- Packet delivery ratio: `0.84375`
- Total outage (s): `60.0`
...
```bash
otns-replay fed_simple_parent_switch_20260710T174604Z.replay
```
