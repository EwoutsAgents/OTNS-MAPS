# Result: fed_simple_parent_switch / 20260710-191119-run01
...
- Switch count: `1`
- First switch time (s): `724.0`
- Switch position x: `750.0`
- Packet delivery ratio: `0.858871`
...
```bash
otns-replay fed_simple_parent_switch_20260710T191119Z.replay
```
