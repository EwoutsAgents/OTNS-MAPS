# Result: fed_simple_parent_switch / 20260712-152325-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10450`
...
- Time spent by parent (s): `{'router_a': 27.0, 'router_b': 45.0, 'router_c': 264.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T152325Z.replay
```
