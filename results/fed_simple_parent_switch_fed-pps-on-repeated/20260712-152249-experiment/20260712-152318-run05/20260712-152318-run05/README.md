# Result: fed_simple_parent_switch / 20260712-152318-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10440`
...
- Time spent by parent (s): `{'router_b': 98.0, 'router_c': 238.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T152318Z.replay
```
