# Result: fed_simple_parent_switch / 20260712-152340-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10470`
...
- Packet delivery ratio: `0.953177`
- Total outage (s): `51.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b']`
- Time spent by parent (s): `{'router_a': 71.0, 'router_b': 264.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T152340Z.replay
```
