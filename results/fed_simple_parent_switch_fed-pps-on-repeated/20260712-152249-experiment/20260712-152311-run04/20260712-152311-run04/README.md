# Result: fed_simple_parent_switch / 20260712-152311-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10430`
...
- Time spent by parent (s): `{'router_a': 83.0, 'router_c': 253.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T152311Z.replay
```
