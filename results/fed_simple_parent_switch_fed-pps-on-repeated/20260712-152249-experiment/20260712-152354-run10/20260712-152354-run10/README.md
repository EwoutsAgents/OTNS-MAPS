# Result: fed_simple_parent_switch / 20260712-152354-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10490`
...
- Packet delivery ratio: `0.993865`
- Total outage (s): `12.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 21.0, 'router_c': 315.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T152354Z.replay
```
