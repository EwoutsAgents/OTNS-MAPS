# Result: fed_simple_parent_switch / 20260712-152347-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10480`
...
- Time spent by parent (s): `{'router_a': 24.0, 'router_c': 312.0}`
...
```bash
otns-replay fed_simple_parent_switch_20260712T152347Z.replay
```
