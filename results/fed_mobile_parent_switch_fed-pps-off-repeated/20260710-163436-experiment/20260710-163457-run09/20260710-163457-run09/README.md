# Result: fed_mobile_parent_switch / 20260710-163457-run01
...
- Packet delivery ratio: `0.625`
- Total outage (s): `340.0`
...
```bash
otns-replay fed_mobile_parent_switch_20260710T163457Z.replay
```
