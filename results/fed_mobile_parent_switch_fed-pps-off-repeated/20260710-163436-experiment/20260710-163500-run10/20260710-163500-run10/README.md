# Result: fed_mobile_parent_switch / 20260710-163500-run01
...
- Switch count: `3`
- First switch time (s): `600.0`
- Switch position x: `202.564`
...
```bash
otns-replay fed_mobile_parent_switch_20260710T163500Z.replay
```
