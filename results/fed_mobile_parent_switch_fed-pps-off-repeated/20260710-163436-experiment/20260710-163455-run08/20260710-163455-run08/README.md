# Result: fed_mobile_parent_switch / 20260710-163455-run01
...
- Switch count: `1`
- First switch time (s): `740.0`
- Switch position x: `346.154`
- Packet delivery ratio: `0.479167`
- Total outage (s): `40.0`
...
```bash
otns-replay fed_mobile_parent_switch_20260710T163455Z.replay
```
