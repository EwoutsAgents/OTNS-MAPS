# Result: fed_mobile_parent_switch / 20260710-163450-run01
...
- Switch count: `1`
- First switch time (s): `760.0`
- Switch position x: `366.667`
...
```bash
otns-replay fed_mobile_parent_switch_20260710T163450Z.replay
```
