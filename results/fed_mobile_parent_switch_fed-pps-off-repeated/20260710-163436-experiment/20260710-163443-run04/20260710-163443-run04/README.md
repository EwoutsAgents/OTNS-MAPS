# Result: fed_mobile_parent_switch / 20260710-163443-run01
...
- Packet delivery ratio: `0.40625`
- Total outage (s): `180.0`
...
```bash
otns-replay fed_mobile_parent_switch_20260710T163443Z.replay
```
