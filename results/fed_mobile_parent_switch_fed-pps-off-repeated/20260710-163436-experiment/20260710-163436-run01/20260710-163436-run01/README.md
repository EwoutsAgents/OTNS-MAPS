# Result: fed_mobile_parent_switch / 20260710-163436-run01
...
- Packet delivery ratio: `0.65625`
- Total outage (s): `300.0`
...
```bash
otns-replay fed_mobile_parent_switch_20260710T163436Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py fed_mobile_parent_switch_20260710T163436Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
