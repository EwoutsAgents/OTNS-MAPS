# Result: sed_simple_parent_switch / 20260713-010451-run01
...
- Time spent by parent (s): `{'router_a': 35.0, 'router_b': 311.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010451Z.replay
```
