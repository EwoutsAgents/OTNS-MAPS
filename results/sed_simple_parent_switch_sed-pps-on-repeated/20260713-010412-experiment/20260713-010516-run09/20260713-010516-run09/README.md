# Result: sed_simple_parent_switch / 20260713-010516-run01
...
- Time spent by parent (s): `{'router_a': 25.0, 'router_c': 320.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010516Z.replay
```
