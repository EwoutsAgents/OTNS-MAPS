# Result: sed_simple_parent_switch / 20260713-010412-run01
...
- Time spent by parent (s): `{'router_a': 21.0, 'router_c': 324.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010412Z.replay
```
