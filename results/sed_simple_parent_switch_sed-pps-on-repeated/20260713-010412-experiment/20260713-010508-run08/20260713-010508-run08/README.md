# Result: sed_simple_parent_switch / 20260713-010508-run01
...
- Packet delivery ratio: `0.98494`
- Total outage (s): `3.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 27.0, 'router_c': 316.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010508Z.replay
```
