# Result: sed_simple_parent_switch / 20260713-010419-run01
...
- Time spent by parent (s): `{'router_a': 26.0, 'router_b': 317.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010419Z.replay
```
