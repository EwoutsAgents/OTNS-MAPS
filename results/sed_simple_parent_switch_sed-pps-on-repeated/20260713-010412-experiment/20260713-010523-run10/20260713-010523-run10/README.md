# Result: sed_simple_parent_switch / 20260713-010523-run01
...
- Switch count: `1`
- First switch time (s): `504.0`
- Second switch time (s): `None`
- Switch position x: `1500.0`
- Second switch position x: `None`
- Detach count: `1`
- First detach time (s): `503.0`
- First detach position x: `1450.0`
- First reattach time (s): `504.0`
- First reattach position x: `1500.0`
...
- Time spent by parent (s): `{'router_a': 22.0, 'router_c': 323.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010523Z.replay
```
