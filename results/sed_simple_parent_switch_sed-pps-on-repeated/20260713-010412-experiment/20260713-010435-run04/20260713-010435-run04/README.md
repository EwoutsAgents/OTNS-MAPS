# Result: sed_simple_parent_switch / 20260713-010435-run01
...
- Time spent by parent (s): `{'router_a': 24.0, 'router_c': 319.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010435Z.replay
```
