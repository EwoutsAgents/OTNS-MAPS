# Result: sed_simple_parent_switch / 20260713-010428-run01
...
- Time spent by parent (s): `{'router_a': 31.0, 'router_c': 314.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T010428Z.replay
```
