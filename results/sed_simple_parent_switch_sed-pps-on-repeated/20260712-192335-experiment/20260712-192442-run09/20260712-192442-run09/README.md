# Result: sed_simple_parent_switch / 20260712-192442-run01
...
- Second switch time (s): `551.0`
- Switch position x: `1500.0`
- Second switch position x: `1500.0`
- Packet delivery ratio: `0.988095`
- Total outage (s): `3.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c', 'router_b']`
- Time spent by parent (s): `{'router_a': 29.0, 'router_c': 38.0, 'router_b': 281.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T192442Z.replay
```
