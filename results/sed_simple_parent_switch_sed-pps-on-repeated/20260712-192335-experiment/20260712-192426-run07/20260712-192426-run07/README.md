# Result: sed_simple_parent_switch / 20260712-192426-run01
...
- Time spent by parent (s): `{'router_a': 34.0, 'router_b': 314.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T192426Z.replay
```
