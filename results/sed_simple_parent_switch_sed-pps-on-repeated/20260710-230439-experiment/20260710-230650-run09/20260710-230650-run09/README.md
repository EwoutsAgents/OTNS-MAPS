# Result: sed_simple_parent_switch / 20260710-230650-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10580`
...
```bash
otns-replay sed_simple_parent_switch_20260710T230650Z.replay
```
