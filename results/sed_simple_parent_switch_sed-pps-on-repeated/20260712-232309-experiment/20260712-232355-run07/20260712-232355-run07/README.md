# Result: sed_simple_parent_switch / 20260712-232355-run01
...
- Switch count: `2`
- First switch time (s): `200.0`
- Second switch time (s): `226.0`
- Switch position x: `800.0`
- Second switch position x: `1600.0`
- Detach count: `1`
- First detach time (s): `225.0`
- First detach position x: `1600.0`
- First reattach time (s): `226.0`
...
- Packet delivery ratio: `0.978723`
- Total outage (s): `1.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_c']`
- Time spent by parent (s): `{'router_a': 9.0, 'router_b': 25.0, 'router_c': 311.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T232355Z.replay
```
