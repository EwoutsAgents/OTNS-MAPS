# Result: sed_simple_parent_switch / 20260712-232411-run01
...
- Time spent by parent (s): `{'router_a': 29.0, 'router_b': 315.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T232411Z.replay
```
