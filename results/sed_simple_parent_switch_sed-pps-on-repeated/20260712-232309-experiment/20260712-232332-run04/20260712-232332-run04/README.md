# Result: sed_simple_parent_switch / 20260712-232332-run01
...
- Time spent by parent (s): `{'router_a': 27.0, 'router_c': 318.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T232332Z.replay
```
