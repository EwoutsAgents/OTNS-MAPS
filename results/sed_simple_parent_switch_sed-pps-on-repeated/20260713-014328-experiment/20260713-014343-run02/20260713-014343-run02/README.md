# Result: sed_simple_parent_switch / 20260713-014343-run01
...
- Packet delivery ratio: `0.990115`
- Total outage (s): `3.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b']`
- Time spent by parent (s): `{'router_a': 30.0, 'router_b': 593.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T014343Z.replay
```
