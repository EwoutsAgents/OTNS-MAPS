# Result: sed_simple_parent_switch / 20260713-014529-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10070`
...
- Packet delivery ratio: `0.99183`
- Total outage (s): `3.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 24.0, 'router_c': 599.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T014529Z.replay
```
