# Result: sed_simple_parent_switch / 20260713-014459-run01
...
- Packet delivery ratio: `0.991883`
- Total outage (s): `0.0`
- Oscillation events: `0`
- Parent sequence: `['router_a']`
- Time spent by parent (s): `{'router_a': 626.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T014459Z.replay
```
