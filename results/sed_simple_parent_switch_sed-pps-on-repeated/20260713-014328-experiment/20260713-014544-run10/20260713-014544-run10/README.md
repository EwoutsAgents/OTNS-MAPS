# Result: sed_simple_parent_switch / 20260713-014544-run01
...
- Time spent by parent (s): `{'router_a': 24.0, 'router_c': 601.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T014544Z.replay
```
