# Result: sed_simple_parent_switch / 20260713-014328-run01
...
- Time spent by parent (s): `{'router_a': 27.0, 'router_c': 598.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T014328Z.replay
```
