# Result: sed_simple_parent_switch / 20260713-024233-run01
...
- Switch count: `2`
- First switch time (s): `1211.0`
- Second switch time (s): `1241.0`
- Switch position x: `843.056`
- Second switch position x: `2125.0`
- Detach count: `1`
- First detach time (s): `1240.0`
- First detach position x: `2125.0`
- First reattach time (s): `1241.0`
...
- Packet delivery ratio: `0.987055`
- Total outage (s): `1.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_d']`
- Time spent by parent (s): `{'router_a': 10.0, 'router_b': 29.0, 'router_d': 597.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T024233Z.replay
```
