# Result: sed_simple_parent_switch / 20260713-024054-run01
...
- Detach count: `1`
- First detach time (s): `1236.0`
- First detach position x: `2075.694`
...
- Packet delivery ratio: `0.98546`
- Total outage (s): `1.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_d']`
- Time spent by parent (s): `{'router_a': 35.0, 'router_d': 601.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T024054Z.replay
```
