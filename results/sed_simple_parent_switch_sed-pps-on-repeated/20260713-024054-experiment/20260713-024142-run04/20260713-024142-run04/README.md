# Result: sed_simple_parent_switch / 20260713-024142-run01
...
- Packet delivery ratio: `0.983687`
- Total outage (s): `4.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c', 'router_d']`
- Time spent by parent (s): `{'router_a': 28.0, 'router_c': 164.0, 'router_d': 441.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T024142Z.replay
```
