# Result: sed_simple_parent_switch / 20260713-024307-run01
...
- Second switch time (s): `1263.0`
- Switch position x: `1681.25`
- Second switch position x: `2125.0`
- Detach count: `1`
- First detach time (s): `1227.0`
- First detach position x: `1631.944`
- First reattach time (s): `1228.0`
- First reattach position x: `1681.25`
- Reattach latency (s): `1.0`
- Ended detached: `False`
- Recovery classification: `detached_reattached_new_parent`
- Packet delivery ratio: `0.987118`
- Total outage (s): `1.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c', 'router_d']`
- Time spent by parent (s): `{'router_a': 26.0, 'router_c': 35.0, 'router_d': 575.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T024307Z.replay
```
