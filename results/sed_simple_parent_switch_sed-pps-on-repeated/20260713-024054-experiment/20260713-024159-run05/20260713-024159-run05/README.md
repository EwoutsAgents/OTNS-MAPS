# Result: sed_simple_parent_switch / 20260713-024159-run01
...
- First detach position x: `1829.167`
...
- Packet delivery ratio: `0.990354`
- Total outage (s): `1.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_d']`
- Time spent by parent (s): `{'router_a': 30.0, 'router_d': 606.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T024159Z.replay
```
