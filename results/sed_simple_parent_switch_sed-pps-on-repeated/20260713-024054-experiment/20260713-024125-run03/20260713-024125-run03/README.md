# Result: sed_simple_parent_switch / 20260713-024125-run01
...
- Time spent by parent (s): `{'router_a': 24.0, 'router_c': 45.0, 'router_d': 567.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T024125Z.replay
```
