# Result: sed_simple_parent_switch / 20260713-024323-run01
...
- Packet delivery ratio: `0.988333`
- Total outage (s): `22.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 32.0, 'router_c': 583.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260713T024323Z.replay
```
