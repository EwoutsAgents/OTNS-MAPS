# Result: sed_simple_parent_switch / 20260712-152537-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10620`
...
- Time spent by parent (s): `{'router_a': 24.0, 'router_c': 311.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T152537Z.replay
```
