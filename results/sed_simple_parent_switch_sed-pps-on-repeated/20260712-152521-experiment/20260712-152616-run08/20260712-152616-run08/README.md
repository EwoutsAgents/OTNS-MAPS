# Result: sed_simple_parent_switch / 20260712-152616-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10670`
...
- Time spent by parent (s): `{'router_a': 22.0, 'router_c': 314.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T152616Z.replay
```
