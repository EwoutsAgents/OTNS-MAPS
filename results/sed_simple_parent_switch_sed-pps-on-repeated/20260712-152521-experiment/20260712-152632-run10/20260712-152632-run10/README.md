# Result: sed_simple_parent_switch / 20260712-152632-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10690`
...
- Packet delivery ratio: `0.984472`
- Total outage (s): `3.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b']`
- Time spent by parent (s): `{'router_a': 24.0, 'router_b': 309.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T152632Z.replay
```
