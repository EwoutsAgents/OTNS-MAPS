# Result: sed_simple_parent_switch / 20260712-152552-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10640`
...
- Time spent by parent (s): `{'router_a': 40.0, 'router_c': 296.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T152552Z.replay
```
