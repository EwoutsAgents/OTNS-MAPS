# Result: sed_simple_parent_switch / 20260712-211121-run01
...
- Switch count: `2`
- First switch time (s): `217.0`
- Second switch time (s): `388.0`
- Switch position x: `1600.0`
- Second switch position x: `1600.0`
- Packet delivery ratio: `0.975155`
- Total outage (s): `6.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c', 'router_b']`
- Time spent by parent (s): `{'router_a': 23.0, 'router_c': 168.0, 'router_b': 149.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T211121Z.replay
```
