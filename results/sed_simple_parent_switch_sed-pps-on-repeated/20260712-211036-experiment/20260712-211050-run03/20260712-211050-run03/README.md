# Result: sed_simple_parent_switch / 20260712-211050-run01
...
- Time spent by parent (s): `{'router_a': 32.0, 'router_c': 311.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T211050Z.replay
```
