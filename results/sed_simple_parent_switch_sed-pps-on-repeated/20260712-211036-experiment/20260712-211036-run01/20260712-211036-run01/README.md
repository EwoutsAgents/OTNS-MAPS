# Result: sed_simple_parent_switch / 20260712-211036-run01
...
```bash
otns-replay sed_simple_parent_switch_20260712T211036Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py sed_simple_parent_switch_20260712T211036Z.replay --frame-count 24 --replay-speed 16 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
