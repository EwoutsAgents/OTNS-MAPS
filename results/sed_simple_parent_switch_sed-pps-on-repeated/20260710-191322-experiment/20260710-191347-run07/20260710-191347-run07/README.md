# Result: sed_simple_parent_switch / 20260710-191347-run01
...
- Switch count: `1`
- First switch time (s): `554.0`
- Switch position x: `750.0`
- Packet delivery ratio: `0.005714`
- Total outage (s): `0.0`
...
```bash
otns-replay sed_simple_parent_switch_20260710T191347Z.replay
```
