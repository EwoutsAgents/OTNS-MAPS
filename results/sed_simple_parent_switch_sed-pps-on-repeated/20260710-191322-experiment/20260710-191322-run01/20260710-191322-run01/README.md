# Result: sed_simple_parent_switch / 20260710-191322-run01
...
- Switch count: `1`
- First switch time (s): `553.0`
- Switch position x: `750.0`
- Packet delivery ratio: `0.011236`
- Total outage (s): `0.0`
...
```bash
otns-replay sed_simple_parent_switch_20260710T191322Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py sed_simple_parent_switch_20260710T191322Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
