# Result: sed_simple_parent_switch / 20260710-191329-run01
...
- Switch count: `1`
- First switch time (s): `581.0`
- Switch position x: `750.0`
- Packet delivery ratio: `0.010638`
- Total outage (s): `1.0`
...
```bash
otns-replay sed_simple_parent_switch_20260710T191329Z.replay
```
