# Result: sed_simple_parent_switch / 20260712-170128-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11690`
...
- Time spent by parent (s): `{'router_a': 32.0, 'router_b': 310.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T170128Z.replay
```
