# Result: sed_simple_parent_switch / 20260712-170046-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11630`
...
- Total outage (s): `311.0`
- Oscillation events: `0`
- Parent sequence: `['router_a']`
- Time spent by parent (s): `{'router_a': 33.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T170046Z.replay
```
