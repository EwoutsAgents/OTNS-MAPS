# Result: sed_simple_parent_switch / 20260712-170023-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11600`
...
- Packet delivery ratio: `0.981763`
- Total outage (s): `3.0`
...
```bash
otns-replay sed_simple_parent_switch_20260712T170023Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py sed_simple_parent_switch_20260712T170023Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
