# Result: sed_simple_parent_switch / 20260712-170105-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11660`
...
- Time spent by parent (s): `{'router_a': 26.0, 'router_c': 316.0}`
...
```bash
otns-replay sed_simple_parent_switch_20260712T170105Z.replay
```
