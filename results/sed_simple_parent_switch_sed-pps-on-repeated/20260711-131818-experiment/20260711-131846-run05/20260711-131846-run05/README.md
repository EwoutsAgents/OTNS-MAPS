# Result: sed_simple_parent_switch / 20260711-131846-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10540`
...
```bash
otns-replay sed_simple_parent_switch_20260711T131846Z.replay
```
