# Result: sed_mobile_parent_switch / 20260710-164025-run01
...
- Switch count: `1`
- First switch time (s): `1500.0`
- Switch position x: `829.143`
...
```bash
otns-replay sed_mobile_parent_switch_20260710T164025Z.replay
```
