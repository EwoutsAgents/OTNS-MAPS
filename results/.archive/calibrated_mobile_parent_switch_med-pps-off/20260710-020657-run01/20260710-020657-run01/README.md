# Result: calibrated_mobile_parent_switch_med-pps-off / 20260710-020657-run01
...
- Packet delivery ratio: `0.833333`
...
```bash
otns-replay calibrated_mobile_parent_switch_20260710T020657Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py calibrated_mobile_parent_switch_20260710T020657Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
