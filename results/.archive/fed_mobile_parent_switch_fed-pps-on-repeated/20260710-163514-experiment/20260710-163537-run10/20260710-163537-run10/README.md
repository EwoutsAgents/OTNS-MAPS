# Result: fed_mobile_parent_switch / 20260710-163537-run01
...
- Switch count: `1`
- First switch time (s): `780.0`
- Switch position x: `387.179`
...
```bash
otns-replay fed_mobile_parent_switch_20260710T163537Z.replay
```
