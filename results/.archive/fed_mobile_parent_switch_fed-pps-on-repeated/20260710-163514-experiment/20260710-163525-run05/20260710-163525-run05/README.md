# Result: fed_mobile_parent_switch / 20260710-163525-run01
...
- Packet delivery ratio: `0.354167`
- Total outage (s): `260.0`
...
```bash
otns-replay fed_mobile_parent_switch_20260710T163525Z.replay
```
