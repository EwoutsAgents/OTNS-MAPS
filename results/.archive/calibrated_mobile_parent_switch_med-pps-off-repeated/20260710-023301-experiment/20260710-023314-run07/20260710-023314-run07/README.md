# Result: calibrated_mobile_parent_switch / 20260710-023314-run01
...
- Packet delivery ratio: `0.635417`
...
```bash
otns-replay calibrated_mobile_parent_switch_20260710T023314Z.replay
```
