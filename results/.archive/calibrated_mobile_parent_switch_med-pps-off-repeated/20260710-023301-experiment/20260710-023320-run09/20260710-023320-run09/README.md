# Result: calibrated_mobile_parent_switch / 20260710-023320-run01
...
- Switch position x: `571.795`
- Packet delivery ratio: `0.541667`
- Total outage (s): `60.0`
...
```bash
otns-replay calibrated_mobile_parent_switch_20260710T023320Z.replay
```
