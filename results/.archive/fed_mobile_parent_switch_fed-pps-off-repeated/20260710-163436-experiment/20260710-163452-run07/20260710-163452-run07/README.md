# Result: fed_mobile_parent_switch / 20260710-163452-run01
...
- Packet delivery ratio: `0.416667`
- Total outage (s): `160.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_a', 'router_b']`
...
```bash
otns-replay fed_mobile_parent_switch_20260710T163452Z.replay
```
