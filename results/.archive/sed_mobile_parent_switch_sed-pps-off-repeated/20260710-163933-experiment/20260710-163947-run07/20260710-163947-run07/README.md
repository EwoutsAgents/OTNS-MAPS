# Result: sed_mobile_parent_switch / 20260710-163947-run01
...
- Switch count: `1`
- First switch time (s): `1170.0`
- Switch position x: `552.571`
...
```bash
otns-replay sed_mobile_parent_switch_20260710T163947Z.replay
```
