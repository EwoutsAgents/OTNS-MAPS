# Result: calibrated_mobile_parent_switch / 20260710-023359-run01
...
- Packet delivery ratio: `0.458333`
- Total outage (s): `80.0`
...
```bash
otns-replay calibrated_mobile_parent_switch_20260710T023359Z.replay
```
