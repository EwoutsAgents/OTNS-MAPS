# Result: calibrated_mobile_parent_switch / 20260710-023344-run01
...
- Packet delivery ratio: `0.333333`
...
```bash
otns-replay calibrated_mobile_parent_switch_20260710T023344Z.replay
```
