# Result: med_simple_parent_switch / 20260710-190557-run01
...
- Switch count: `1`
- First switch time (s): `509.0`
- Switch position x: `750.0`
- Packet delivery ratio: `0.998459`
- Total outage (s): `5.0`
...
```bash
otns-replay med_simple_parent_switch_20260710T190557Z.replay
```
