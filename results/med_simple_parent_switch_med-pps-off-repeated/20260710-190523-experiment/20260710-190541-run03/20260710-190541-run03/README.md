# Result: med_simple_parent_switch / 20260710-190541-run01
...
- Packet delivery ratio: `0.732026`
- Total outage (s): `172.0`
...
```bash
otns-replay med_simple_parent_switch_20260710T190541Z.replay
```
