# Result: med_simple_parent_switch / 20260710-190609-run01
...
- Switch count: `1`
- First switch time (s): `721.0`
- Switch position x: `750.0`
- Packet delivery ratio: `0.611111`
- Total outage (s): `234.0`
...
```bash
otns-replay med_simple_parent_switch_20260710T190609Z.replay
```
