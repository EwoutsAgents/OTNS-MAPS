# Result: med_simple_parent_switch / 20260710-210817-run01
...
- Switch count: `1`
- First switch time (s): `626.0`
- Switch position x: `750.0`
- Packet delivery ratio: `0.990654`
- Total outage (s): `15.0`
...
```bash
otns-replay med_simple_parent_switch_20260710T210817Z.replay
```
