# Result: med_simple_parent_switch / 20260712-210513-run01
...
- Time spent by parent (s): `{'router_a': 30.0, 'router_c': 315.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T210513Z.replay
```
