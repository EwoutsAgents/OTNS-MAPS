# Result: med_simple_parent_switch / 20260712-210456-run01
...
- Total outage (s): `333.0`
- Oscillation events: `0`
- Parent sequence: `['router_a']`
- Time spent by parent (s): `{'router_a': 30.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T210456Z.replay
```
