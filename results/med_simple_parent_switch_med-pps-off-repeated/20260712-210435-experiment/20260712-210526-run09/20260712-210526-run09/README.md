# Result: med_simple_parent_switch / 20260712-210526-run01
...
- Time spent by parent (s): `{'router_a': 34.0, 'router_c': 309.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T210526Z.replay
```
