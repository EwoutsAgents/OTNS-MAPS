# Result: med_simple_parent_switch / 20260713-013229-run01
...
- Packet delivery ratio: `0.993528`
- Total outage (s): `12.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 23.0, 'router_c': 602.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T013229Z.replay
```
