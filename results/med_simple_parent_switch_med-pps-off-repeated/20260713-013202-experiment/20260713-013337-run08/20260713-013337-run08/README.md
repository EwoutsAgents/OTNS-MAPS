# Result: med_simple_parent_switch / 20260713-013337-run01
...
- Time spent by parent (s): `{'router_a': 27.0, 'router_c': 599.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T013337Z.replay
```
