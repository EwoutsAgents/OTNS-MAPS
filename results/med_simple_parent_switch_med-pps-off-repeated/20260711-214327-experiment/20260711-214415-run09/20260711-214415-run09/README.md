# Result: med_simple_parent_switch / 20260711-214415-run01
...
- Switch count: `1`
- First switch time (s): `520.0`
- Switch position x: `900.0`
- Packet delivery ratio: `0.977987`
- Total outage (s): `25.0`
...
```bash
otns-replay med_simple_parent_switch_20260711T214415Z.replay
```
