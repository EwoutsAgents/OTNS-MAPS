# Result: med_simple_parent_switch / 20260712-191820-run01
...
- Packet delivery ratio: `0.982143`
- Total outage (s): `21.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 39.0, 'router_c': 310.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191820Z.replay
```
