# Result: med_simple_parent_switch / 20260712-191827-run01
...
- Time spent by parent (s): `{'router_a': 28.0, 'router_b': 315.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191827Z.replay
```
