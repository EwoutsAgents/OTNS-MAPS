# Result: med_simple_parent_switch / 20260712-191814-run01
...
- Packet delivery ratio: `0.972028`
- Total outage (s): `73.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 34.0, 'router_c': 270.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191814Z.replay
```
