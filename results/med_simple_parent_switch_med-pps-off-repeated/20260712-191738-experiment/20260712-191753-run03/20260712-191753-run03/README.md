# Result: med_simple_parent_switch / 20260712-191753-run01
...
- Time spent by parent (s): `{'router_a': 129.0, 'router_c': 219.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191753Z.replay
```
