# Result: med_simple_parent_switch / 20260712-191807-run01
...
- Time spent by parent (s): `{'router_a': 37.0, 'router_c': 311.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191807Z.replay
```
