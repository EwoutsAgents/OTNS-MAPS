# Result: med_simple_parent_switch / 20260712-191834-run01
...
- Time spent by parent (s): `{'router_a': 33.0, 'router_b': 316.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191834Z.replay
```
