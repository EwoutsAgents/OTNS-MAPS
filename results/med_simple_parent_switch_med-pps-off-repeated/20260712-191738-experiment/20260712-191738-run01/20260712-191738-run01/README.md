# Result: med_simple_parent_switch / 20260712-191738-run01
...
- Packet delivery ratio: `0.979228`
- Total outage (s): `21.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 39.0, 'router_c': 312.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191738Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py med_simple_parent_switch_20260712T191738Z.replay --frame-count 24 --replay-speed 16 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
