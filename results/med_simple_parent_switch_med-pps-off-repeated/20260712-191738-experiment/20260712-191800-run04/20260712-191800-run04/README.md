# Result: med_simple_parent_switch / 20260712-191800-run01
...
- Packet delivery ratio: `0.988338`
- Total outage (s): `12.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 32.0, 'router_c': 318.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191800Z.replay
```
