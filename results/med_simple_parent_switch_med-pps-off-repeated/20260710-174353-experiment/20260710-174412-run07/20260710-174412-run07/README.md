# Result: med_simple_parent_switch / 20260710-174412-run01
...
- Switch position x: `608.974`
- Packet delivery ratio: `0.854167`
...
```bash
otns-replay med_simple_parent_switch_20260710T174412Z.replay
```
