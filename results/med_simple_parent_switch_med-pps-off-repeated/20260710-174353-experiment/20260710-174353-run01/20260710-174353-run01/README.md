# Result: med_simple_parent_switch / 20260710-174353-run01
...
```bash
otns-replay med_simple_parent_switch_20260710T174353Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py med_simple_parent_switch_20260710T174353Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
