# Result: med_simple_parent_switch / 20260712-231737-run01
...
- Result classification: `detached_reattached_same_parent`
...
```bash
otns-replay med_simple_parent_switch_20260712T231737Z.replay
```
