# Result: med_simple_parent_switch / 20260713-022840-run01
...
- Time spent by parent (s): `{'router_a': 28.0, 'router_d': 608.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T022840Z.replay
```
