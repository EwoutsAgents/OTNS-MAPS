# Result: med_simple_parent_switch / 20260713-022908-run01
...
- Packet delivery ratio: `0.987034`
- Total outage (s): `28.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_d']`
- Time spent by parent (s): `{'router_a': 37.0, 'router_d': 597.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T022908Z.replay
```
