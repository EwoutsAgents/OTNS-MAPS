# Result: med_simple_parent_switch / 20260713-023036-run01
...
- Time spent by parent (s): `{'router_a': 22.0, 'router_c': 19.0, 'router_d': 591.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T023036Z.replay
```
