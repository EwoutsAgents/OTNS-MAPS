# Result: med_simple_parent_switch / 20260713-022826-run01
...
- Packet delivery ratio: `0.986992`
- Total outage (s): `30.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_d']`
- Time spent by parent (s): `{'router_a': 28.0, 'router_b': 11.0, 'router_d': 596.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T022826Z.replay
```
