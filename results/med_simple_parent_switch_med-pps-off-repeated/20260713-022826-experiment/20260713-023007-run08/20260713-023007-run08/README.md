# Result: med_simple_parent_switch / 20260713-023007-run01
...
- Time spent by parent (s): `{'router_a': 32.0, 'router_d': 605.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T023007Z.replay
```
