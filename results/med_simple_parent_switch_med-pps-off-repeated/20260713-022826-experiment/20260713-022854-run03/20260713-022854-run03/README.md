# Result: med_simple_parent_switch / 20260713-022854-run01
...
- Packet delivery ratio: `0.98505`
- Total outage (s): `44.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_d']`
- Time spent by parent (s): `{'router_a': 40.0, 'router_b': 166.0, 'router_d': 425.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T022854Z.replay
```
