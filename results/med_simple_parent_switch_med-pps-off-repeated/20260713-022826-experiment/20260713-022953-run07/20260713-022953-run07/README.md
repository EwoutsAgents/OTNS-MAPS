# Result: med_simple_parent_switch / 20260713-022953-run01
...
- Time spent by parent (s): `{'router_a': 38.0, 'router_d': 598.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T022953Z.replay
```
