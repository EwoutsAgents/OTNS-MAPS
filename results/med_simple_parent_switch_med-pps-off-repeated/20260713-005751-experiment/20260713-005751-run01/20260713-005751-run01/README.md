# Result: med_simple_parent_switch / 20260713-005751-run01
...
- Time spent by parent (s): `{'router_a': 24.0, 'router_c': 322.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T005751Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py med_simple_parent_switch_20260713T005751Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
