# Result: med_simple_parent_switch / 20260712-165523-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11180`
...
- Packet delivery ratio: `0.984894`
- Total outage (s): `19.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 32.0, 'router_c': 310.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T165523Z.replay
```
