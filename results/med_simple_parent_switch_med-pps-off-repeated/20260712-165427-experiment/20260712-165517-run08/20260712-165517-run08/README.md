# Result: med_simple_parent_switch / 20260712-165517-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11170`
...
- Packet delivery ratio: `0.988131`
- Total outage (s): `12.0`
...
```bash
otns-replay med_simple_parent_switch_20260712T165517Z.replay
```
