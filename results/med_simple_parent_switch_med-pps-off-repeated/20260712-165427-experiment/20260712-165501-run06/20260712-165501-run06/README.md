# Result: med_simple_parent_switch / 20260712-165501-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11150`
...
- Packet delivery ratio: `0.951456`
- Total outage (s): `51.0`
...
```bash
otns-replay med_simple_parent_switch_20260712T165501Z.replay
```
