# Result: med_simple_parent_switch / 20260712-165510-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11160`
...
- Packet delivery ratio: `0.990909`
- Total outage (s): `18.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 29.0, 'router_c': 315.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T165510Z.replay
```
