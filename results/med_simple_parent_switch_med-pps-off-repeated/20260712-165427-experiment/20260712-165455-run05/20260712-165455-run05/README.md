# Result: med_simple_parent_switch / 20260712-165455-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11140`
...
- Packet delivery ratio: `0.987879`
- Total outage (s): `19.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 33.0, 'router_c': 309.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T165455Z.replay
```
