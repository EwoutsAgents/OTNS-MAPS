# Result: med_simple_parent_switch / 20260712-165448-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11130`
...
- Time spent by parent (s): `{'router_a': 27.0, 'router_b': 315.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T165448Z.replay
```
