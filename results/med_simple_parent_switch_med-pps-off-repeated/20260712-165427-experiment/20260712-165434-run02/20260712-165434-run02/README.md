# Result: med_simple_parent_switch / 20260712-165434-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11110`
...
- Packet delivery ratio: `0.984756`
- Total outage (s): `22.0`
...
```bash
otns-replay med_simple_parent_switch_20260712T165434Z.replay
```
