# Result: sed_mobile_parent_switch_sed-pps-off / 20260710-104537-run01
...
- Switch count: `1`
- First switch time (s): `1350.0`
- Switch position x: `703.429`
- Packet delivery ratio: `0.013889`
- Total outage (s): `0.0`
...
```bash
otns-replay sed_mobile_parent_switch_20260710T104537Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py sed_mobile_parent_switch_20260710T104537Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
