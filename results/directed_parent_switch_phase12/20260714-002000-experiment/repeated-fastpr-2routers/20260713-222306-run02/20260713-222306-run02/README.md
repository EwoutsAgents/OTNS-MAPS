# Result: med_directed_ucast_fastpr_2routers / 20260713-222306-run01
...
- Preferred-parent event CSV: `preferred_parent_events_20260713T222306Z.csv`
...
```bash
otns-replay med_directed_ucast_fastpr_2routers_20260713T222306Z.replay
```
