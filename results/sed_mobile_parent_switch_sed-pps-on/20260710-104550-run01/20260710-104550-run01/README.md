# Result: sed_mobile_parent_switch_sed-pps-on / 20260710-104550-run01
...
- Switch count: `1`
- First switch time (s): `1110.0`
- Switch position x: `502.286`
...
```bash
otns-replay sed_mobile_parent_switch_20260710T104550Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py sed_mobile_parent_switch_20260710T104550Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
