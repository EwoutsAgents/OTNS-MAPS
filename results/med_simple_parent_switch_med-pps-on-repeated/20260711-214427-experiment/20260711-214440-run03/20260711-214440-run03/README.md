# Result: med_simple_parent_switch / 20260711-214440-run01
...
- Switch count: `1`
- First switch time (s): `506.0`
- Switch position x: `900.0`
- Packet delivery ratio: `0.990826`
- Total outage (s): `12.0`
...
```bash
otns-replay med_simple_parent_switch_20260711T214440Z.replay
```
