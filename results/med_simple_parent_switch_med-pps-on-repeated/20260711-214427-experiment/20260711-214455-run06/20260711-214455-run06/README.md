# Result: med_simple_parent_switch / 20260711-214455-run01
...
- Switch count: `1`
- First switch time (s): `491.0`
- Switch position x: `650.0`
...
```bash
otns-replay med_simple_parent_switch_20260711T214455Z.replay
```
