# Result: med_simple_parent_switch / 20260711-214446-run01
...
- Switch count: `1`
- First switch time (s): `801.0`
- Switch position x: `900.0`
- Packet delivery ratio: `0.882353`
- Total outage (s): `306.0`
...
```bash
otns-replay med_simple_parent_switch_20260711T214446Z.replay
```
