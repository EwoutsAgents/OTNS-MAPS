# Result: med_simple_parent_switch / 20260711-214513-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10090`
...
```bash
otns-replay med_simple_parent_switch_20260711T214513Z.replay
```
