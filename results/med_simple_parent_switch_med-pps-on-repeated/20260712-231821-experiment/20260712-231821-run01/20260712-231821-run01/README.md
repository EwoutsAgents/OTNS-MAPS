# Result: med_simple_parent_switch / 20260712-231821-run01
...
- Time spent by parent (s): `{'router_a': 28.0, 'router_c': 318.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T231821Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py med_simple_parent_switch_20260712T231821Z.replay --frame-count 24 --replay-speed 16 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
