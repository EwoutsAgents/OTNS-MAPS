# Result: med_simple_parent_switch / 20260712-231828-run01
...
- Packet delivery ratio: `0.968354`
- Total outage (s): `40.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 164.0, 'router_c': 179.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T231828Z.replay
```
