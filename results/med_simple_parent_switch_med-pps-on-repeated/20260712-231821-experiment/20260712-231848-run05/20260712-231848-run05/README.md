# Result: med_simple_parent_switch / 20260712-231848-run01
...
- Time spent by parent (s): `{'router_a': 32.0, 'router_c': 312.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T231848Z.replay
```
