# Result: med_simple_parent_switch / 20260710-190807-run01
...
- Switch count: `1`
- First switch time (s): `557.0`
- Switch position x: `750.0`
- Packet delivery ratio: `0.996997`
- Total outage (s): `1.0`
...
```bash
otns-replay med_simple_parent_switch_20260710T190807Z.replay
```
