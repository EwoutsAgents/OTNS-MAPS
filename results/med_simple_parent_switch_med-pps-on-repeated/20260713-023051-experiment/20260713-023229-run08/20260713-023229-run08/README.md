# Result: med_simple_parent_switch / 20260713-023229-run01
...
- Time spent by parent (s): `{'router_a': 33.0, 'router_d': 604.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T023229Z.replay
```
