# Result: med_simple_parent_switch / 20260713-023243-run01
...
- Packet delivery ratio: `0.98539`
- Total outage (s): `30.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_d']`
- Time spent by parent (s): `{'router_a': 39.0, 'router_d': 597.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T023243Z.replay
```
