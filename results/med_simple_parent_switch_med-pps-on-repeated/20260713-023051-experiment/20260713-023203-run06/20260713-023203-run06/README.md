# Result: med_simple_parent_switch / 20260713-023203-run01
...
- Time spent by parent (s): `{'router_a': 9.0, 'router_b': 628.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T023203Z.replay
```
