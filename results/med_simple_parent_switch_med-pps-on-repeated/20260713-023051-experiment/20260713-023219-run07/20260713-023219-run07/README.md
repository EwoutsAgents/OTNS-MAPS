# Result: med_simple_parent_switch / 20260713-023219-run01
...
- Detach count: `1`
- First detach time (s): `1450.0`
- First detach position x: `2125.0`
- First reattach time (s): `1451.0`
...
- Packet delivery ratio: `0.101449`
- Total outage (s): `615.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b']`
- Time spent by parent (s): `{'router_a': 9.0, 'router_b': 627.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T023219Z.replay
```
