# Result: med_simple_parent_switch / 20260713-023104-run01
...
- Switch count: `2`
- First switch time (s): `1217.0`
- Second switch time (s): `1248.0`
- Switch position x: `1138.889`
- Second switch position x: `2125.0`
- Detach count: `1`
- First detach time (s): `1246.0`
...
- Packet delivery ratio: `0.995153`
- Total outage (s): `21.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c', 'router_b']`
- Time spent by parent (s): `{'router_a': 16.0, 'router_c': 29.0, 'router_b': 590.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T023104Z.replay
```
