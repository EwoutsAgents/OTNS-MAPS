# Result: med_simple_parent_switch / 20260713-023149-run01
...
- Time spent by parent (s): `{'router_a': 36.0, 'router_d': 598.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T023149Z.replay
```
