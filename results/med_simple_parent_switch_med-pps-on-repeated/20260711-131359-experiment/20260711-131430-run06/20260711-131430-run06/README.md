# Result: med_simple_parent_switch / 20260711-131430-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10150`
...
```bash
otns-replay med_simple_parent_switch_20260711T131430Z.replay
```
