# Result: med_simple_parent_switch / 20260711-131412-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10120`
...
```bash
otns-replay med_simple_parent_switch_20260711T131412Z.replay
```
