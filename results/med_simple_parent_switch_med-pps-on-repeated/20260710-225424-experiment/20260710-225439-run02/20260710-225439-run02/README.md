# Result: med_simple_parent_switch / 20260710-225439-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10110`
...
- Packet delivery ratio: `0.995825`
- Total outage (s): `3.0`
...
```bash
otns-replay med_simple_parent_switch_20260710T225439Z.replay
```
