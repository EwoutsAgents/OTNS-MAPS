# Result: med_simple_parent_switch / 20260710-225600-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10170`
...
```bash
otns-replay med_simple_parent_switch_20260710T225600Z.replay
```
