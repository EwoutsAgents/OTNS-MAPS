# Result: med_simple_parent_switch / 20260710-225551-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10160`
...
- Packet delivery ratio: `0.997006`
- Total outage (s): `0.0`
...
```bash
otns-replay med_simple_parent_switch_20260710T225551Z.replay
```
