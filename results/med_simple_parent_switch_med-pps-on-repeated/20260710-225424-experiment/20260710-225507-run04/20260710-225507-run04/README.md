# Result: med_simple_parent_switch / 20260710-225507-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10130`
...
- Packet delivery ratio: `0.987578`
- Total outage (s): `15.0`
...
```bash
otns-replay med_simple_parent_switch_20260710T225507Z.replay
```
