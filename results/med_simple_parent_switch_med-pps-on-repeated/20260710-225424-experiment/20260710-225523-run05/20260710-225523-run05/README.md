# Result: med_simple_parent_switch / 20260710-225523-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10140`
...
```bash
otns-replay med_simple_parent_switch_20260710T225523Z.replay
```
