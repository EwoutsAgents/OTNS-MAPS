# Result: med_simple_parent_switch / 20260712-210632-run01
...
- Time spent by parent (s): `{'router_a': 13.0, 'router_b': 333.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T210632Z.replay
```
