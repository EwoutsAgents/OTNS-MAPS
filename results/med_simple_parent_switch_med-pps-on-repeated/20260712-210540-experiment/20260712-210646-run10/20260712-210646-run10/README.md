# Result: med_simple_parent_switch / 20260712-210646-run01
...
- Time spent by parent (s): `{'router_a': 29.0, 'router_b': 314.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T210646Z.replay
```
