# Result: med_simple_parent_switch / 20260712-210540-run01
...
- Second switch time (s): `258.0`
- Switch position x: `1600.0`
- Second switch position x: `1600.0`
- Packet delivery ratio: `0.978593`
- Total outage (s): `26.0`
- Oscillation events: `1`
- Parent sequence: `['router_a', 'router_b', 'router_a']`
- Time spent by parent (s): `{'router_a': 301.0, 'router_b': 41.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T210540Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py med_simple_parent_switch_20260712T210540Z.replay --frame-count 24 --replay-speed 16 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
