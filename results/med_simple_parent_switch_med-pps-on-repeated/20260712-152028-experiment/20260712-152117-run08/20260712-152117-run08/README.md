# Result: med_simple_parent_switch / 20260712-152117-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10270`
...
- Time spent by parent (s): `{'router_a': 114.0, 'router_c': 222.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T152117Z.replay
```
