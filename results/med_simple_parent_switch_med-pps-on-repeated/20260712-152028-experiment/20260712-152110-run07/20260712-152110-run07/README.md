# Result: med_simple_parent_switch / 20260712-152110-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10260`
...
- Packet delivery ratio: `0.990712`
- Total outage (s): `16.0`
...
```bash
otns-replay med_simple_parent_switch_20260712T152110Z.replay
```
