# Result: med_simple_parent_switch / 20260712-152103-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:10250`
...
- Time spent by parent (s): `{'router_a': 42.0, 'router_b': 293.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T152103Z.replay
```
