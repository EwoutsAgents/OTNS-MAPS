# Result: med_simple_parent_switch / 20260712-165617-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11260`
...
- Time spent by parent (s): `{'router_a': 24.0, 'router_c': 318.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T165617Z.replay
```
