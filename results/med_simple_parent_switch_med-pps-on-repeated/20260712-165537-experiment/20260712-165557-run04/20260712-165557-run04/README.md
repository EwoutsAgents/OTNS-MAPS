# Result: med_simple_parent_switch / 20260712-165557-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11230`
...
```bash
otns-replay med_simple_parent_switch_20260712T165557Z.replay
```
