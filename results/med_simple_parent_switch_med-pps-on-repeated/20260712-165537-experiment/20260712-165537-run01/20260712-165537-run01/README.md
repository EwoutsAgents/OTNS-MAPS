# Result: med_simple_parent_switch / 20260712-165537-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11200`
...
- Time spent by parent (s): `{'router_a': 30.0, 'router_c': 314.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T165537Z.replay
```

- Rendered from the replay with `python3 scripts/replay_to_mp4.py med_simple_parent_switch_20260712T165537Z.replay --frame-count 24 --replay-speed 4 --cover-full-replay --end-device-y-offset 80 --video-fps 8 --show-log-panel --log-lines 10`
