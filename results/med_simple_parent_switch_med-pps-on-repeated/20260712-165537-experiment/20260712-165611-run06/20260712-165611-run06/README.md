# Result: med_simple_parent_switch / 20260712-165611-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11250`
...
- Packet delivery ratio: `0.981928`
- Total outage (s): `19.0`
...
```bash
otns-replay med_simple_parent_switch_20260712T165611Z.replay
```
