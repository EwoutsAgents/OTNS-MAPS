# Result: med_simple_parent_switch / 20260712-165604-run01
...
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:11240`
...
```bash
otns-replay med_simple_parent_switch_20260712T165604Z.replay
```
