# Result: med_simple_parent_switch / 20260713-010004-run01
...
- Switch count: `2`
- First switch time (s): `495.0`
- Second switch time (s): `516.0`
...
- Time spent by parent (s): `{'router_a': 14.0, 'router_b': 20.0, 'router_c': 311.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T010004Z.replay
```
