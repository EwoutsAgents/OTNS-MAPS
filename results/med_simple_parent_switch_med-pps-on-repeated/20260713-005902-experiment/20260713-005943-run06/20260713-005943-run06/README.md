# Result: med_simple_parent_switch / 20260713-005943-run01
...
- Time spent by parent (s): `{'router_a': 10.0, 'router_b': 22.0, 'router_c': 314.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T005943Z.replay
```
