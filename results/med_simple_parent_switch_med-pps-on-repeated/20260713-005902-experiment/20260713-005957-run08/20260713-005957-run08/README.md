# Result: med_simple_parent_switch / 20260713-005957-run01
...
- Time spent by parent (s): `{'router_a': 12.0, 'router_b': 21.0, 'router_c': 310.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T005957Z.replay
```
