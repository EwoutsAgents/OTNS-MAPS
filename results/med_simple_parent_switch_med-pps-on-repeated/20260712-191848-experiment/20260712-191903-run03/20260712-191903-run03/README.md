# Result: med_simple_parent_switch / 20260712-191903-run01
...
- Packet delivery ratio: `0.991304`
- Total outage (s): `9.0`
- Oscillation events: `0`
- Parent sequence: `['router_a']`
- Time spent by parent (s): `{'router_a': 351.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191903Z.replay
```
