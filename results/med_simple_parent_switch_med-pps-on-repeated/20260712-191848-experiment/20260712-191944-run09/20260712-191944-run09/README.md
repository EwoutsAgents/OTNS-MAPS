# Result: med_simple_parent_switch / 20260712-191944-run01
...
- Time spent by parent (s): `{'router_a': 35.0, 'router_c': 313.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191944Z.replay
```
