# Result: med_simple_parent_switch / 20260712-191910-run01
...
- Time spent by parent (s): `{'router_a': 34.0, 'router_c': 314.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191910Z.replay
```
