# Result: med_simple_parent_switch / 20260712-191951-run01
...
- Packet delivery ratio: `0.982301`
- Total outage (s): `18.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_c']`
- Time spent by parent (s): `{'router_a': 35.0, 'router_c': 315.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191951Z.replay
```
