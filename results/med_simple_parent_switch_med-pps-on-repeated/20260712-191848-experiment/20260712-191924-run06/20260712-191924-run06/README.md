# Result: med_simple_parent_switch / 20260712-191924-run01
...
- Time spent by parent (s): `{'router_a': 36.0, 'router_c': 312.0}`
...
```bash
otns-replay med_simple_parent_switch_20260712T191924Z.replay
```
