# Result: med_simple_parent_switch / 20260713-013518-run01
...
- Packet delivery ratio: `0.986644`
- Total outage (s): `35.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_c']`
- Time spent by parent (s): `{'router_a': 34.0, 'router_b': 445.0, 'router_c': 141.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T013518Z.replay
```
