# Result: med_simple_parent_switch / 20260713-013429-run01
...
- Switch count: `1`
- First switch time (s): `1214.0`
- Second switch time (s): `None`
- Switch position x: `1000.0`
- Second switch position x: `None`
- Detach count: `1`
- First detach time (s): `1454.0`
- First detach position x: `1600.0`
- First reattach time (s): `1455.0`
...
- Packet delivery ratio: `0.09596`
- Total outage (s): `606.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b']`
- Time spent by parent (s): `{'router_a': 13.0, 'router_b': 612.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T013429Z.replay
```
