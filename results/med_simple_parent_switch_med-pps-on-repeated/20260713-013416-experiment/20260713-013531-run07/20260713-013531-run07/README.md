# Result: med_simple_parent_switch / 20260713-013531-run01
...
- Switch count: `2`
- First switch time (s): `1213.0`
- Second switch time (s): `1237.0`
- Switch position x: `950.0`
...
- Packet delivery ratio: `0.993485`
- Total outage (s): `16.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_c']`
- Time spent by parent (s): `{'router_a': 12.0, 'router_b': 21.0, 'router_c': 590.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T013531Z.replay
```
