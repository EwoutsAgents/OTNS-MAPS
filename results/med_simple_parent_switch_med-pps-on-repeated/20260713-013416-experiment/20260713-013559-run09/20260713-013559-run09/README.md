# Result: med_simple_parent_switch / 20260713-013559-run01
...
- Packet delivery ratio: `0.996785`
- Total outage (s): `6.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b']`
- Time spent by parent (s): `{'router_a': 9.0, 'router_b': 617.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T013559Z.replay
```
