# Result: med_simple_parent_switch / 20260713-013545-run01
...
- Second switch time (s): `1588.0`
- Switch position x: `850.0`
- Second switch position x: `1600.0`
- Detach count: `1`
- First detach time (s): `1586.0`
- First detach position x: `1600.0`
- First reattach time (s): `1588.0`
...
- Time spent by parent (s): `{'router_a': 10.0, 'router_b': 375.0, 'router_c': 239.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T013545Z.replay
```
