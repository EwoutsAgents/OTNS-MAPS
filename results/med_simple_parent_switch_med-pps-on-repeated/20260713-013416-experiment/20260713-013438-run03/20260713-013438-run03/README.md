# Result: med_simple_parent_switch / 20260713-013438-run01
...
- Time spent by parent (s): `{'router_a': 37.0, 'router_b': 589.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T013438Z.replay
```
