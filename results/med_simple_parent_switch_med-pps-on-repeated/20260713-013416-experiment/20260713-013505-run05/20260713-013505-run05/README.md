# Result: med_simple_parent_switch / 20260713-013505-run01
...
- Packet delivery ratio: `0.99018`
- Total outage (s): `21.0`
- Oscillation events: `0`
- Parent sequence: `['router_a', 'router_b', 'router_c']`
- Time spent by parent (s): `{'router_a': 12.0, 'router_b': 22.0, 'router_c': 591.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T013505Z.replay
```
