# Result: med_simple_parent_switch / 20260713-013612-run01
...
- Time spent by parent (s): `{'router_a': 34.0, 'router_c': 589.0}`
...
```bash
otns-replay med_simple_parent_switch_20260713T013612Z.replay
```
