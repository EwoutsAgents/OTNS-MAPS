...
- OTNS commit: `099a6c2`
- OTNS command: `/home/ewout/go/bin/otns -web=false -autogo=false -speed 1 -listen localhost:9950`
...
```bash
otns-replay replay/calibrated_mobile_parent_switch_20260707T192957Z.replay
```
